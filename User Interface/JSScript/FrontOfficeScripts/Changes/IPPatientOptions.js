...
function ShowPatHistoryIP() {
    ...
    if (IP_OP == 'IP') {
        ...
        if (document.getElementById('ctl00_ContentPlaceHolder1_umrPatientDetails_Umrlookup_txtSearchControl').value == '') {
            $(".stoast").toastText("warning", "Please select UMR#!.", 5, 3);
            document.getElementById('ctl00_ContentPlaceHolder1_umrPatientDetails_Umrlookup_txtSearchControl').focus();
            return false;
        }
        umrno = document.getElementById('ctl00_ContentPlaceHolder1_umrPatientDetails_Umrlookup_txtSearchControl').value;
        pat_name = document.getElementById('ctl00_ContentPlaceHolder1_umrPatientDetails_lblPatName').innerHTML;
    }
    var PatientID = $('[id*=hdnOptPatientid]').val();
    $("#IPPatHistoryGrid").show();
    if (pat_name == undefined || pat_name == null) { pat_name = ""; }
    $('[id*=lblIPPat_headName]').text('Patient History Of: ' + pat_name);
    ...
    gridControl = $("#IPtbl_PreConsultation").jMtable(param);
    // }
}

function hidePatHistoryIP() {
    $("#IPPatHistoryGrid").hide();
    return false;
}
...
function Patienttaginfo() {
    ...
    if (IP_OP == "IP") {
        ...
        admnNo = document.getElementById('ctl00_ContentPlaceHolder1_umrPatientDetails_ucPatOptions_hdnOptUmrNo').value
    }
...
function ShowRegFaceSheetReport() {
    ...
    if (IP_OP == 'IP') {
        ...
        if (document.getElementById('ctl00_ContentPlaceHolder1_ucRegUMRno_txtSearchControl').value == '') {
            $(".stoast").toastText("warning", "Please select UMR#!.", 5, 3);
            document.getElementById('ctl00_ContentPlaceHolder1_ucRegUMRno_txtSearchControl').focus();
            return false;
        }
    }
    if (IP_OP == 'CHANGE-REG') {
        var clientname = $('[id*=hdnclientNameFor]').val();
        var _patient_id = document.getElementById('ctl00_ContentPlaceHolder1_ucUMRno__hiddenID').value;
        var _umr_no = document.getElementById('ctl00_ContentPlaceHolder1_ucUMRno__hiddenText').value;
        var _reg_no = document.getElementById('ctl00_hdnDMSAdmnNo').value;
        var _receipt_no = document.getElementById('ctl00_ContentPlaceHolder1_txtRegistration').value;
        var _bill_id = document.getElementById('ctl00_ContentPlaceHolder1_hdnBill_ID').value;
    }
    else {
        var clientname = $('[id*=hdnclientNameFor]').val();
        var _patient_id = document.getElementById('ctl00_ContentPlaceHolder1_umrPatientDetails_Umrlookup__hiddenID').value;
        var _umr_no = document.getElementById('ctl00_ContentPlaceHolder1_umrPatientDetails_ucPatOptions_hdnOptUmrNo').value;
        var _reg_no = document.getElementById('ctl00_hdnDMSAdmnNo').value;
        var _receipt_no = document.getElementById('ctl00_ContentPlaceHolder1_umrPatientDetails_hdnBillNo').value;
        var _bill_id = document.getElementById('ctl00_ContentPlaceHolder1_umrPatientDetails_hdnbillid').value;
    }
    var type = "REG";
    var authorized_user = '';
    ...
    GetAsync(
                "Private/FrontOffice/Registrations.aspx/CallPrint",
                { Patient_ID: _patient_id, Umr_NO: _umr_no, Reg_NO: _reg_no, ReqType: type, Receipt_NO: _receipt_no, authorized_user: authorized_user, _bill_id: _bill_id, documentid: "64", clientname: clientname, docid: '', RDFFormat: RDFFormat },
                function (_path) {
...
function ShowRegCardReport() {
    ...
    if (IP_OP == 'CHANGE-REG') {
        var clientname = $('[id*=hdnclientNameFor]').val();
        var _bill_no = document.getElementById('ctl00_ContentPlaceHolder1_txtRegistration').value;
        var _photo = '';
        var _bill_id = document.getElementById('ctl00_ContentPlaceHolder1_hdnBill_ID').value;
    }
    else {
        var clientname = $('[id*=hdnclientNameFor]').val();
        var _bill_no = document.getElementById('ctl00_ContentPlaceHolder1_umrPatientDetails_hdnBillNo').value;
        var _photo = '';
        var _bill_id = document.getElementById('ctl00_ContentPlaceHolder1_umrPatientDetails_hdnbillid').value;
    }
    if (clientname == "UHWI") {
        ...
        GetAsync(
                ...
                { _billid: billid, Dispatch: _dispatch, _patclsid: patclsid },
                function (_path) {
                    _path = _path.d;
                    window.open(_path);
                    return false;
...
function showPatAddressIP() {
    ...
    if (pat_name == undefined || pat_name == null) { pat_name = ""; }
    $('[id*=lblPat_addressIP]').text('Address Details of: ' + pat_name);
    AssignBannerAddressDetailsIP(IP_OP);
    $("#patAddressPopupIP").show();

    return false;
}
function HidePatAddressIP() {
    $("#patAddressPopupIP").hide();
    return false;
}
function AssignBannerAddressDetailsIP(obj) {
    var PatientID = $('[id*=hdnOptPatientid]').val();
...
function changregdetIP() {
    ...
    if ($('[id*=hdnCntrlType]').val() == "IPBAN") {
        ...
        if (document.getElementById('ctl00_ContentPlaceHolder1_umrPatientDetails_ucPatOptions_hdnOptUmrNo').value == '' || document.getElementById('ctl00_ContentPlaceHolder1_umrPatientDetails_ucPatOptions_hdnOptUmrNo').value == null || document.getElementById('ctl00_ContentPlaceHolder1_umrPatientDetails_ucPatOptions_hdnOptUmrNo').value == undefined) {
    ...
    if ($('[id*=hdnISOSP]').value == "Y") {
        ...
        window.location = _iniUrl + 'Private/FrontOffice/OpBilling/OPChanges/New_IPRegistrationChengesDetails.aspx?PAT_ID=' + patid + "&UMR_NO=" + umrno + "&pageurl=" + window.location.origin + window.location.pathname + Str + "&FORM_NAME=" + form_name + "&DOC_FORM_CD=CHANGE-REG&SRC_DOC_FORM_CD=" + srcdocformcd + "&AdmnNo=" + admnno;
    
    }

}
function ShowPatNotificationsIP() {
    var IP_OP = $('[id*=HDN_IP_OP]').val();
    if (IP_OP == 'IP') {
        if (document.getElementById('ctl00_ContentPlaceHolder1_AdmnPatientDetails_ucUmrNo_txtSearchControl').value == '') {
            $(".stoast").toastText("warning", "Please select admission number!", 5, 3);
            document.getElementById('ctl00_ContentPlaceHolder1_AdmnPatientDetails_ucUmrNo_txtSearchControl').focus();
            return false;
        }
    }
    else {
    ...
    if (parseFloat($('[id*=hdnoutstanding_due]').val()) > 0) {
        if (document.getElementById('ctl00_ContentPlaceHolder1_umrPatientDetails_hdnbasecurrancy').value == "INDIAN RUPEE")
            $(".stoast").toastText("Info", 'This UMR_NO ' + document.getElementById('ctl00_ContentPlaceHolder1_umrPatientDetails_Umrlookup_txtSearchControl').value + ' having due of <i class="icon-rupee"></i>' + $('[id*=hdnoutstanding_due]').val(), 5, 2);
        else
            $(".stoast").toastText("Info", 'This UMR_NO ' + document.getElementById('ctl00_ContentPlaceHolder1_umrPatientDetails_Umrlookup_txtSearchControl').value + ' having due of <i class="icon-dollar"></i>' + $('[id*=hdnoutstanding_due]').val(), 5, 2);
    }
    if (parseFloat($('[id*=hdnrefund]').val()) > 0) {
        if (document.getElementById('ctl00_ContentPlaceHolder1_umrPatientDetails_hdnbasecurrancy').value == "INDIAN RUPEE")
            $(".stoast").toastText("Info", 'This UMR_NO ' + document.getElementById('ctl00_ContentPlaceHolder1_umrPatientDetails_Umrlookup_txtSearchControl').value + ' having Refundable amount of <i class="icon-rupee"></i>' + $('[id*=hdnrefund]').val(), 5, 2);
        else
            $(".stoast").toastText("Info", 'This UMR_NO ' + document.getElementById('ctl00_ContentPlaceHolder1_umrPatientDetails_Umrlookup_txtSearchControl').value + ' having Refundable amount of <i class="icon-dollar"></i>' + $('[id*=hdnrefund]').val(), 5, 2);
    }
    if (parseFloat($('[id*=hdnpreadvance]').val()) > 0) {
        if (document.getElementById('ctl00_ContentPlaceHolder1_umrPatientDetails_hdnbasecurrancy').value == "INDIAN RUPEE")
            $(".stoast").toastText("Info", 'This UMR_NO ' + document.getElementById('ctl00_ContentPlaceHolder1_umrPatientDetails_Umrlookup_txtSearchControl').value + ' having Pre Advance amount <i class="icon-rupee"></i>' + $('[id*=hdnpreadvance]').val(), 5, 2);
        else
            $(".stoast").toastText("Info", 'This UMR_NO ' + document.getElementById('ctl00_ContentPlaceHolder1_umrPatientDetails_Umrlookup_txtSearchControl').value + ' having Pre Advance amount <i class="icon-dollar"></i>' + $('[id*=hdnpreadvance]').val(), 5, 2);
    }
    ...
    if (parseFloat($('[id*=hdnfundexpamt]').val()) > 0) {
        if (document.getElementById('ctl00_ContentPlaceHolder1_umrPatientDetails_hdnbasecurrancy').value == "INDIAN RUPEE")
            $(".stoast").toastText("Info", 'This UMR_NO ' + document.getElementById('ctl00_ContentPlaceHolder1_umrPatientDetails_Umrlookup_txtSearchControl').value + ' having Fund amount of ' + $('[id*=hdnfundexpamt]').val() + '<i class="icon-rupee"></i>  Expire within ' + $('[id*=hdnfundexpdays]').val(), 5, 2);
        else
            $(".stoast").toastText("Info", 'This UMR_NO ' + document.getElementById('ctl00_ContentPlaceHolder1_umrPatientDetails_Umrlookup_txtSearchControl').value + ' having Fund amount of ' + $('[id*=hdnfundexpamt]').val() + '<i class="icon-dollar"></i>  Expire within ' + $('[id*=hdnfundexpdays]').val(), 5, 2);
    }
    if (parseFloat($('[id*=hdnrefund]').val()) > 0) {
        $(".stoast").toastText("Info", 'This UMR_NO ' + document.getElementById('ctl00_ContentPlaceHolder1_umrPatientDetails_Umrlookup_txtSearchControl').value + ' having Refundable amount of ' + $('[id*=hdnrefund]').val(), 5, 2);
    }
    return false;
}

function ShowPatAllergiesIP() {
    ...
    if (IP_OP == 'IP') {
        umr_no = $('[id*=hdnOptUmrNo]').val();//  $('[id*=AdmnPatientDetails_ucAdmission_txtSearchControl]').val();
        if (umr_no == undefined || umr_no == null) {
            umr_no = document.getElementById('ctl00_ContentPlaceHolder1_IPPatientDtls1_ucUmrNo_txtSearchControl').value// $('[id*=UCPatientDetails_ucAdmission_txtSearchControl]').val();
        }
        if (umr_no == undefined || umr_no == null) {
            umr_no = "";
        }
        ...
        umr_no = $('[id*=hdnOptUmrNo]').val(); //document.getElementById('ctl00_ContentPlaceHolder1_umrPatientDetails_Umrlookup_txtSearchControl').value;
        if (umr_no == '') {
            $(".stoast").toastText("warning", "Please select UMR#!.", 5, 3);
            document.getElementById('ctl00_ContentPlaceHolder1_umrPatientDetails_Umrlookup_txtSearchControl').focus();
            return false;
    ...
    //, { col: "Allergy Cd", sort: true, filter: true }
    // , { col: "Allergy Status", sort: true, filter: true }
    // , { col: "Start Dt", sort: true, filter: true }
    // , { col: "End Dt", sort: true, filter: true }
    // , { col: "First Observed", sort: true, filter: true }
    , { col: "Notes", sort: true, filter: true }
    //, { col: "Duration", sort: true, filter: true }
    ...
    gridControl_allergies = $("#tbl_PatAllergiesIP").jtable(param_allergies);
    $("#divPatAllergiesIP").show();
}

function hidePatAllergiesIP() {
    $("#divPatAllergiesIP").hide();
    return false;
}

function ClinicalFlagsIP(ev) {
    AssignBannerClinicalFlagsIP(ev);
    return false;
}
function AssignBannerClinicalFlagsIP(ev) {
    $('#PatientClicinalFlagsIP table tr td').find('[id*=lblacuity]').text('');
    $('#PatientClicinalFlagsIP table tr td').find('[id*=lblstart]').text('');
    $('#PatientClicinalFlagsIP table tr td').find('[id*=lblInfectuas]').text('');
    $('#PatientClicinalFlagsIP table tr td').find('[id*=lblCentralinemonitoring]').text('');
    $('#PatientClicinalFlagsIP table tr td').find('[id*=lblDrains]').text('');
    var patId = $('[id*=hdnOptPatientid]').val();
    var admnId = $('[id*=hdnOptAdmnID]').val();
    if (patId != "" && admnId != "") {
        GetAsync(
                    ...
                    function (jdata) {
                        ...
                        if (jdata.d.length > 0) {
                            if (jdata.d[0]["Acuity"] == null && jdata.d[0]["NBM"] == null && jdata.d[0]["Infectuas"] == null && jdata.d[0]["Centralinemonitoring"] == null && jdata.d[0]["Centralinemonitoring"] == null) {
                                ...
                                $("#PatientClicinalFlagsIP").hide();
                            }
                            else {
                                $("#PatientClicinalFlagsIP").show();
                                $('#PatientClicinalFlagsIP table tr td').find('[id*=lblacuity]').text(jdata.d[0]["Acuity"] != null ? jdata.d[0]["Acuity"] : 'NO');
                                $('#PatientClicinalFlagsIP table tr td').find('[id*=lblstart]').text(jdata.d[0]["NBM"] != null ? jdata.d[0]["NBM"] : 'NO');
                                $('#PatientClicinalFlagsIP table tr td').find('[id*=lblInfectuas]').text(jdata.d[0]["Infectuas"] != null ? jdata.d[0]["Infectuas"] : 'NO');
                                $('#PatientClicinalFlagsIP table tr td').find('[id*=lblCentralinemonitoring]').text(jdata.d[0]["Centralinemonitoring"] != null ? jdata.d[0]["Centralinemonitoring"] : 'NO');
                                $('#PatientClicinalFlagsIP table tr td').find('[id*=lblDrains]').text(jdata.d[0]["Drains"] != null ? jdata.d[0]["Drains"] : 'NO');
                            }
                        }
                        else {
                            return false;
...
function HidePatientClicinalFlagsIP() {
    $("#PatientClicinalFlagsIP").hide();
    return false;
}

function PatOptionControl(admnid, patid, umrno,admnno) {
    /*document.getElementById('<%=hdnOptAdmnID.ClientID %>').value = admnid;
    document.getElementById('<%=hdnOptPatientid.ClientID %>').value = patid;*/
    $('[id*=hdnOptPatientid]').val(patid);
    $('[id*=hdnOptAdmnID]').val(admnid);
    $('[id*=hdnOptUmrNo]').val(umrno);
    $('[id*=hdnOptAdmnNo]').val(admnno);
}
    ...
    if (Tran_src_id == '2') {
        ...
        $('[id*=divchecklist] ul[id*=ul_chk_list1] li').each(function () {
            if ($(this).closest('li').find('input[id*=chklst]')[0].checked == true) {
                ...
                var remarks_type = $(this).closest('li').find('input[id*=txtremarks]').val();*/
                var chktypeid = $(this).find('[type=hidden][id*=hdnchklistypeid]').val();
                if (remarks_type != '') {
...
function AccessOPTIONSAddDisableAttributes() {
    ...
    if (hdnAddDisableAttr != "" && hdnAddDisableAttr != undefined && hdnAddDisableAttr != null) {
        ...
        for (var i = 0; i < regDoc.length; i++) {
            ...
            switch (docIds) {
                case "LIPATALLERGIES":
                    $('[id$=lipatallergiesIP]').hide();
                    break;
                case "LIPATADDRESS":
                    $('[id$=lipataddressIP]').hide();
                    break;
                case "LIPATTAG":
                    $('[id$=lipattag]').hide();
                    break;
                case "LIPATHISTORY":
                    $('[id$=lipathistoryIP]').hide();
                    break;
                case "LIPATNOTIFICATION":
                    $('[id$=lipatnotificationIP]').hide();
                    break;
                case "CLINICALFLAGS":
                    $('[id$=clinicalflagsIP]').hide();
                    break;
...
/*Commented by Swetha Reddy, Un Useful Code adding the commented block ,if any of the function is using in another pages please let me know */
/*
function ShowPatEmergencyDetails() {
if ($('[id*=hdnCntrlType]').val() == "IPBAN") {
AssignEmergancyDetails('IP');
}
else {
AssignEmergancyDetails('OP');
}
return false;
}
function AssignEmergancyDetails(obj) {
var adminID = 0;
if (obj == 'IP') {
if ($('[id*=hdnOptAdmnID]').val() == '' || $('[id*=hdnOptAdmnID]').val() == undefined || $('[id*=hdnOptAdmnID]').val() == null) {
$(".stoast").toastText("warning", "Admin# Shouldn't Be Empty", 5, 3);
...
param.pageSize = 10;
param.pageNum = 1;
param.defaultWSParams = { admnId: parseInt(adminID), sessionId: parseInt(sessionID) };
param.wsPath = "PatientRegistration.asmx/GetPatAttandantDetails";
param.wsFilterPath = "PatientRegistration.asmx/GetPatAttandantDetails";
param.template = ["NAME*NAME"
, "MOBILE_PHONE*MOBILE_PHONE"
, "ADDRESS1*ADDRESS1"];
param.header = [{ col: "Name", sort: true, filter: true }
, { col: "Mobile Phn", sort: false }
, { col: "Address", sort: true, filter: true}];
param.enablePaging = false;
param.enableTrace = false;
...
param.tableTemplate = true;
param.enableDMS = false;
gridControl = $("#tbl_EmergencyDetails").jtable(param);
$("#EmergancyDetails").show();
}
function HideEmergencyDetails() {
$("#EmergancyDetails").hide();
return false;
}
function ShowPatDocuments() {
if (document.getElementById('ctl00_ContentPlaceHolder1_umrPatientDetails_Umrlookup_txtSearchControl').value == '') {
$(".stoast").toastText("warning", "Please select UMR#!.", 5, 3);
document.getElementById('ctl00_ContentPlaceHolder1_umrPatientDetails_Umrlookup_txtSearchControl').focus();
return false;
}
var UmrNo = $('#ctl00_ContentPlaceHolder1_umrPatientDetails_Umrlookup_txtSearchControl').val();
window.open(_iniUrl + 'Private/FrontOffice/MultiFileupload/Upload.aspx?UmrNo=' + UmrNo + '' + '', '' + '' + '', '' + 'fullscreen=no,maximize=1,top=100,left=350,right=0,bottom=0,toolbar=no,status=no,location=no,menubar=no,addressbar=no,address=no,scrollbar=no,width=600,height=450');
return false;
}
function ShowPatdownLoadedDocuments() {
if (document.getElementById('ctl00_ContentPlaceHolder1_umrPatientDetails_Umrlookup_txtSearchControl').value == '') {
$(".stoast").toastText("warning", "Please select UMR#!.", 5, 3);
document.getElementById('ctl00_ContentPlaceHolder1_umrPatientDetails_Umrlookup_txtSearchControl').focus();
return false;
}
var Umr_No = document.getElementById('ctl00_ContentPlaceHolder1_umrPatientDetails_Umrlookup_txtSearchControl').value;
var Admn_No = '';
GetAsync(
"Private/Diagnostics/DispatchDashBoard.aspx/ViewDownLoadDocument",
{ Umr_No: Umr_No },
function (data) {
ViewMyWindow(data, Umr_No);
},
function (jqXHR, textStatus, errorThrown) {
});
return false;
...
var path = b;
document.getElementById('ctl00_ContentPlaceHolder1_umrPatientDetails_ucPatOptions_hdnsrcname').value = path;
var src = document.getElementById('ctl00_ContentPlaceHolder1_umrPatientDetails_ucPatOptions_hdnsrcname').value;
_dat += '<li><img id="imgview" onClick="Imageview(src);" style=\"height:100px;width:100px;\" src="' + path + '"' + '</li>';
...
function prvdetails() {
if ($('[id*=hdnudocname]').val() == "IP Discharge") {
if (document.getElementById('ctl00_ContentPlaceHolder1_UcpatientDl_ucAdmission_txtSearchControl').value == '') {
$(".stoast").toastText("warning", "Please select UMR#!.", 5, 3);
document.getElementById('ctl00_ContentPlaceHolder1_UcpatientDl_ucAdmission_txtSearchControl').focus();
return false;
}
else {
var umrno = document.getElementById('ctl00_ContentPlaceHolder1_UcpatientDl_ucAdmission_txtSearchControl').value;
}
}
else if ($('[id*=hdnudocname]').val() == "IP Advance") {
if (document.getElementById('ctl00_ContentPlaceHolder1_AdmnPatientDetails_ucAdmission_txtSearchControl').value == '') {
$(".stoast").toastText("warning", "Please select UMR#!.", 5, 3);
document.getElementById('ctl00_ContentPlaceHolder1_AdmnPatientDetails_ucAdmission_txtSearchControl').focus();
return false;
}
else {
var umrno = document.getElementById('ctl00_ContentPlaceHolder1_AdmnPatientDetails_ucAdmission_txtSearchControl').value;
}
}
else if ($('[id*=hdnudocname]').val() == "IPFinalBill") {
if (document.getElementById('ctl00_ContentPlaceHolder1_IPPatientDtls1_ucAdmission_txtSearchControl').value == '') {
$(".stoast").toastText("warning", "Please select UMR#!.", 5, 3);
document.getElementById('ctl00_ContentPlaceHolder1_IPPatientDtls1_ucAdmission_txtSearchControl').focus();
return false;
}
else {
var umrno = document.getElementById('ctl00_ContentPlaceHolder1_IPPatientDtls1_ucAdmission_txtSearchControl').value;
}
}
else if ($('[id*=hdnudocname]').val() == "Imrserentry") {
...
var patclass = $('[id*=hdnpatientclass]').val();
if (patclass == "I" || patclass == "IP") {
if (document.getElementById('ctl00_ContentPlaceHolder1_IPPatientDtls1_ucAdmission_txtSearchControl').value == '') {
$(".stoast").toastText("warning", "Please select UMR#!.", 5, 3);
document.getElementById('ctl00_ContentPlaceHolder1_IPPatientDtls1_ucAdmission_txtSearchControl').focus();
return false;
...
var umrno = document.getElementById('ctl00_ContentPlaceHolder1_umrPatientDetails_Umrlookup_txtSearchControl').value;
}
}
}
$("#divPrevAdmnDet").show();
if (umrno != '' && umrno != undefined && umrno != null) {
var hdnDateFormat = $('[id*=hdnDateFormat]').val();
if (hdnDateFormat == undefined || hdnDateFormat == null || hdnDateFormat == "") { hdnDateFormat = "dd-MMM-yyyy"; }
var hdnTimeFormat = $('[id*=hdnTimeFormat]').val();
if (hdnTimeFormat == undefined || hdnTimeFormat == null || hdnTimeFormat == "") { hdnTimeFormat = "HH:mm:ss"; }
var param = param || {};
param.dataKey = "DISCHRG_ID";
param.pageSize = 10;
param.pageNum = 1;
param.defaultWSParams = { _umrno: umrno };
param.wsPath = "Private/FrontOffice/DayCare/AddNewAdmission.aspx/BindPreAdmnDtls";
param.wsFilterPath = "Private/FrontOffice/DayCare/AddNewAdmission.aspx/BindPreAdmnDtls";
param.template = ["UmrNo*UMR_NO"
, "ADMN_NO*ADMN_NO"
, "DISPLAY_NAME*PATIENT_NAME"
, "ADMITED_DT*ADMN_DT"
, "DISCHARG_DT*DISCHR_DT"
...
, "CMPNY_REFERAL_LETTER_ID*CMPNY_REFERAL_LETTER_ID"
, "REFERAL_LETTER_NO*REFERAL_LETTER_NO"];

param.header = [{ col: "UmrNo", sort: true, filter: true }
, { col: "Admn No", sort: true, filter: true }
, { col: "Patient Name", sort: true, filter: true }
, { col: "Admited Dt", sort: true, filter: true }
, { col: "Discharge Dt", sort: true, filter: true }
, { col: "Consultent Name", sort: false }
, { col: "Ward Name", sort: false }
, { col: "Room  Name", sort: false }
, { col: "Bed Name", sort: false }
, { col: "Gross Amt", sort: false }
, { col: "Concession Amt", sort: false }
, { col: "Due Amt", sort: false }
, { col: "Paid Amt", sort: false }
, { col: "Patient Type", sort: false }
, { col: "Company Referal Id", sort: false }
, { col: "Referal Letter No", sort: false}];
...
var current_format = split[0];
if (i == 3) {
if (_data.ADMITED_DT != undefined && _data.ADMITED_DT != null && _data.ADMITED_DT != "" && _data.ADMITED_DT != "null")
$(this).text(new Date(_data.ADMITED_DT).format(current_format) + " " + new Date(_data.ADMITED_DT).format(hdnTimeFormat));
}
if (i == 4) {
if (_data.DISCHARG_DT != undefined && _data.DISCHARG_DT != null && _data.DISCHARG_DT != "" && _data.DISCHARG_DT != "null")
$(this).text(new Date(_data.DISCHARG_DT).format(current_format) + " " + new Date(_data.DISCHARG_DT).format(hdnTimeFormat));
}
});
return obj[0].outerHTML;
};
gridControl = $("#tbl_PreAdmisions").jtable(param);
}
}
function PrevAdmnsClose() {
$("#divPrevAdmnDet").hide();
return false;
}*/