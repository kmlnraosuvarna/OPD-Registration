...
//    } /* MCI*/
    ...
    if (document.getElementById('' + ctrlcom + '_hdnsvaeclickvalue').value == "1") {
        ...
        if (IsHealthCardReq.toLowerCase() == 'true') {
            $('#' + ctrlcom + '_chkhccrd').parent().show()
        }
        else {
            $('#' + ctrlcom + '_chkhccrd').parent().hide()
        }
       ...
       /* Ontabindex function made only for OPDBILL.aspx*/
      //  Ontabindex(); 
        return false;
    }
...
function selectRegType(obj) {
  //  Clearpopup();
    ...
    if (ddlregtype[val].innerHTML == 'HealthCheck') {
        document.getElementById('' + ctrlcom + '_ChkMlcStatus').disabled = true;
    }
    else {
        document.getElementById('' + ctrlcom + '_ChkMlcStatus').disabled = false;
    }
...
function Clearpopup() {
    if (document.getElementById('' + ctrlcom + '_hdnispatientbaneer').value == 'Y') {
        ...
        clearcontactdetails();
        var _optionsVal1 = "<OPTION selected value='0'>--Select--</OPTION>";
        $('[id$=chkmodeComm_MultiSelectDDL]').empty().html(_optionsVal1);
        $('[id$=chkmodeComm_MultiSelectDDL]').attr("title", "Select Communication mode to interact");
        $('[id*=chkmodeComm_CheckBoxListExCtrl1] tr').find('[id*=CheckBoxListExCtrl]').prop('checked', false);
        clearVisaControls();
        ...
        $('#' + ctrlcom + 'Address1_txtMobile3').val('');
        $('#' + ctrlcom + '_Address1_txtNearestPS').val('');
        $('#' + ctrlcom + '_Address1_txtMobile1').val('');
        ctl00_ContentPlaceHolder1_ddlquestionary.value = 0;
    ...
    if (hdnRegDoctorReq.value == "True") {
        ...
        if (NoofDays > RegDoctorDays) {
            ...
            if (_doctor_id != undefined && _doctor_id != null && _doctor_id != '' && _doctor_id != '0') {
                GetNonAsync(
                          "Private/FrontOffice/OPDBill.aspx/Bind_Consultation_Det_Async",
...
function EnableDisableControls(val) {
    ...
    document.getElementById('' + ctrlcom + '_chkIsSenior').disabled = val;
