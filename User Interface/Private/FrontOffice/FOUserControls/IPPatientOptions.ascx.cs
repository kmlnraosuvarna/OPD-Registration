...
public partial class Private_FrontOffice_FOUserControls_IPPatientOptions : System.Web.UI.UserControl
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (_dsgetdocper != null && _dsgetdocper.Tables[0].Rows.Count > 0)
        {
            if ((_dsgetdocper.Tables[0].Rows[0]["ACCESS_ADD"].ToString()) == "Y")
                chgregiconIP.Style.Add("display", "block");
            else
                chgregiconIP.Style.Add("display", "none");
        }
        else
        {
            chgregiconIP.Style.Add("display", "none");
        ...
        if (OptFlag == "IP")
        {
            clinicalflagsIP.Style.Add("display", "block");
            regfacesheetrpt.Style.Add("display", "none");
            regcardrpt.Style.Add("display", "none");
        }
        else
        {
            clinicalflagsIP.Style.Add("display", "none");
    ...
    {
        //DataSet _dsgetdocper1 = Docpermission.DocpermissionbyDocId(SessionHandler.DOCUMENT_ID);
