<%@ Control Language="C#" AutoEventWireup="true" CodeFile="PatientOptions.ascx.cs"
    Inherits="Private_FrontOffice_FOUserControls_PatientOptions" %>
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        var form_name = "";
        if (document.getElementById('' + ctrlcom + '_umrPatientDetails_hdnDocName') != null) {
            form_name = document.getElementById('' + ctrlcom + '_umrPatientDetails_hdnDocName').value;
        }
        else {
...
<asp:ScriptManagerProxy ID="smp" runat="server">
    <Scripts>
        ...
        <asp:ScriptReference Path="~/JSScript/FrontOfficeScripts/Changes/PatientOptions.js?ver=1.0.1" />
    </Scripts>
...
<legend class="icons">
    <ul>
        ...
        <li id="lipataddress" title="Address" class="tooltip"><i class="icon-location" onclick="return showPatAddress();">
        </i></li>
        <li id="lipatallergies" title="Allergies" class="tooltip"><i class="icon-stethoscope"
            onclick="return ShowPatAllergies();"></i></li>
        <li id="lipathistory" title="History" class="tooltip"><i class=" icon-history" onclick="return ShowPatHistory();">
        </i></li>
        ...
        <li id="lipatnotification" title="Notifications" class="tooltip"><i class="icon-bell"
            onclick="return ShowPatNotifications();"></i></li>
        <li title="Patient Clinical Flags" id="clinicalflags" runat="server" class="tooltip">
            <i class="icon-user-3" onclick="return ClinicalFlags(this);"></i></li>
        <li title="Change Reg Details" id="chgregicon" runat="server" class="tooltip"><i
            class="icon-edit" onclick="return changregdet();"></i></li>
        ...
        <li title="Card Report" id="regcardrpt" runat="server" class="tooltip"><i class=" icon-print-1"
            onclick="return ShowRegCardReport();"></i></li>
              <li title="Bar Code Print" id="Li1" runat="server" class="tooltip gico">

              <img src="../../Assets/Grid_Icons/barcode.png" onclick="return BarcodePrint();">
              <%--<i class=" icon-print-1" onclick="return BarcodePrint();"></i>--%>
            </li>
    </ul>
</legend>
<div class="masking" id="trPatHistoryGrid">
    <div class="cmask">
    </div>
    <div class="clientpopup" style="width: 750px; height: 450px; margin-left: -375px;
        ...
        <div class="pop-header">
            <h1>
                <asp:Label ID="lblpat_head_name" runat="server"></asp:Label>
            </h1>
            <asp:Button buttonaction="cancelButton" ID="Button3" runat="server" CssClass="cbutton"
                Text="&times;" OnClientClick="return hidePatHistory();" />
        </div>
        <div class="pop-body grd" style="overflow: hidden; height: 410px;">
            <div id="tbl_PreConsultation" class="divscroll" style="height: 374px !important;
                overflow: auto;">
            </div>
        </div>
    </div>
</div>
<div class="masking" id="patAddressPopup">
    <div class="cmask">
    </div>
    <div class="clientpopup" style="width: 700px; height: 400px; margin-left: -350px;
        ...
        <div class="pop-header">
            <h1>
                <asp:Label ID="lblPat_address_dtls" runat="server"></asp:Label>
            </h1>
            <asp:Button buttonaction="cancelButton" ID="img4" runat="server" CssClass="cbutton"
                Text="&times;" OnClientClick="return HidePatAddress();" />
        </div>
...
<div class="masking" id="PatientClicinalFlags">
    <div class="cmask">
    </div>
    <div class="clientpopup" style="width: 500px; height: 206px; margin-left: -250px;
        ...
        <div class="pop-header">
            ...
            <asp:Button buttonaction="cancelButton" ID="Button2" runat="server" CssClass="cbutton"
                Text="&times;" OnClientClick="return HidePatientClicinalFlags();" />
        </div>
...
<div class="masking" id="divPatAllergies">
    <div class="cmask">
    </div>
    <div class="clientpopup" style="width: 750px; height: 450px; margin-left: -375px;
        margin-top: -225px;">
        <div class="pop-header">
            ...
            <asp:Button buttonaction="cancelButton" ID="Button1" runat="server" CssClass="cbutton"
                Text="&times;" OnClientClick="return hidePatAllergies();" />
        </div>
        <div class="pop-body grd" style="overflow: hidden; height: 410px;">
            <div id="tbl_PatAllergies" class="divscroll" style="height: 390px !important; overflow: auto;">
            </div>
        </div>
    </div>
</div>
<div class="masking" id="EmergancyDetails">
    <div class="cmask">
    </div>
...
<div>
    ...
    <asp:HiddenField ID="hdncurrdocfrmcd" runat="server" />
</div>
<script type="text/javascript">
    $(document).ready(function () {
