...
function CheckValidation() {
    ...
    var oppriority5 = document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtOPTrf5_txtSearchControl');
    ...
    var ippriority5 = document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtIPTrf5_txtSearchControl');
    ...
    if (Prior1IP.value == '' && ippriority2.value == '' && ippriority3.value == '' && ippriority4.value == '' && ippriority5.value == '') {
    ...
    if (Prior1OP.value == '' && oppriority2.value == '' && oppriority3.value == '' && oppriority4.value == '' && oppriority5.value == '') {
...
function successmsg() {
    window.location.href = _iniUrl + "Private/Corporate/Changes/companymastergrid.aspx";
}
function saveservicegroup() {
    ...
    $('table[id$=gvservicegroup] tr:has(td)').each(function (e) {
        ...
        var COMPANY_SERVICE_TYPE_PRIORITY5 = $(this).closest('tr').find('input[type=text][id*=txtpririty5]').val();
        ...
        var COMPANY_SERVICE_TYPE_ADD_PRCNTGE5 = $(this).closest('tr').find('input[type=text][id*=txtAddpririty5]').val();
        ...
        COMPANY_SERVICE_TYPE_PRIORITY3 = typeof COMPANY_SERVICE_TYPE_PRIORITY3 == "string" ? (COMPANY_SERVICE_TYPE_PRIORITY3.trim() == "0" ? "0" : COMPANY_SERVICE_TYPE_PRIORITY3) : (typeof COMPANY_SERVICE_TYPE_PRIORITY3 == "number" ? COMPANY_SERVICE_TYPE_PRIORITY3 : "0");
        COMPANY_SERVICE_TYPE_PRIORITY5 = typeof COMPANY_SERVICE_TYPE_PRIORITY5 == "string" ? (COMPANY_SERVICE_TYPE_PRIORITY5.trim() == "0" ? "0" : COMPANY_SERVICE_TYPE_PRIORITY5) : (typeof COMPANY_SERVICE_TYPE_PRIORITY5 == "number" ? COMPANY_SERVICE_TYPE_PRIORITY5 : "0");
        ...
        COMPANY_SERVICE_TYPE_ADD_PRCNTGE5 = COMPANY_SERVICE_TYPE_ADD_PRCNTGE5 == "" ? "0" : COMPANY_SERVICE_TYPE_ADD_PRCNTGE5;

        if (COMPANY_SERVICE_TYPE_PRIORITY1 == '' || COMPANY_SERVICE_TYPE_PRIORITY1 == undefined) {
            COMPANY_SERVICE_TYPE_PRIORITY1 = 0;
        }
        if (COMPANY_SERVICE_TYPE_PRIORITY2 == '' || COMPANY_SERVICE_TYPE_PRIORITY2 == undefined) {
            COMPANY_SERVICE_TYPE_PRIORITY2 = 0;
        }
        if (COMPANY_SERVICE_TYPE_PRIORITY3 == '' || COMPANY_SERVICE_TYPE_PRIORITY3 == undefined) {
            COMPANY_SERVICE_TYPE_PRIORITY3 = 0;
        }
        if (COMPANY_SERVICE_TYPE_DEFAULT == '' || COMPANY_SERVICE_TYPE_DEFAULT == undefined) {
            COMPANY_SERVICE_TYPE_DEFAULT = 0;
        }
        if (COMPANY_SERVICE_TYPE_PRIORITY5 == '' || COMPANY_SERVICE_TYPE_PRIORITY5 == undefined) {
            COMPANY_SERVICE_TYPE_PRIORITY5 = 0;
        }

        if (COMPANY_SERVICE_TYPE_ADD_PRCNTGE1 == '' || COMPANY_SERVICE_TYPE_ADD_PRCNTGE1 == undefined) {
            COMPANY_SERVICE_TYPE_ADD_PRCNTGE1 = 0;
        }
        if (COMPANY_SERVICE_TYPE_ADD_PRCNTGE2 == '' || COMPANY_SERVICE_TYPE_ADD_PRCNTGE2 == undefined) {
            COMPANY_SERVICE_TYPE_ADD_PRCNTGE2 = 0;
        }
        if (COMPANY_SERVICE_TYPE_ADD_PRCNTGE3 == '' || COMPANY_SERVICE_TYPE_ADD_PRCNTGE3 == undefined) {
            COMPANY_SERVICE_TYPE_ADD_PRCNTGE3 = 0;
        }
        if (COMPANY_SERVICE_TYPE_ADD_PRCNTGE4 == '' || COMPANY_SERVICE_TYPE_ADD_PRCNTGE4 == undefined) {
            COMPANY_SERVICE_TYPE_ADD_PRCNTGE4 = 0;
        }
        if (COMPANY_SERVICE_TYPE_ADD_PRCNTGE5 == '' || COMPANY_SERVICE_TYPE_ADD_PRCNTGE5 == undefined) {
            COMPANY_SERVICE_TYPE_ADD_PRCNTGE5 = 0;
        }
        ...
        _child1 += " COMPANY_SERVICE_TYPE_PRIORITY5=!" + COMPANY_SERVICE_TYPE_PRIORITY5 + "!";
        ...
        _child1 += " RISE_PECENT5=!" + COMPANY_SERVICE_TYPE_ADD_PRCNTGE5 + "!";
...
function savebillinghead() {
    var CompanyId = getParameterByName('TariffEdit');
    document.getElementById('ctl00_ContentPlaceHolder1_HdnbillingheadxmlData').value = '';
    var _child1 = "";
    _child1 += "<root>";
    $('table[id$=gvbillinghead] tr:has(td)').each(function (e) {
        _child1 += " <COMPANY_SERVICE_TYPE_CONCESSION ";
        var CMP_SRV_TYPE_ID = $(this).closest('tr').find('[id*=hdnautoid]').val();
        var SERVICE_TYPE_REV_NO = $(this).closest('tr').find('[id*=hdnrevno]').val();
        var SERVICE_TYPE_ID = $(this).closest('tr').find('[id*=hdnGroupID]').val();
    ...
    _child1 += "</root>";
    document.getElementById('ctl00_ContentPlaceHolder1_HdnbillingheadxmlData').value = _child1;
}
...
function SaveServiceType() {
    ...
    $('table[id$=gvServicesType] tr:has(td)').each(function (e) {
        ...
        COMPANY_SERVICE_TYPE_PRIORITY5 = typeof COMPANY_SERVICE_TYPE_PRIORITY5 == "string" ? (COMPANY_SERVICE_TYPE_PRIORITY5.trim() == "0" ? "0" : COMPANY_SERVICE_TYPE_PRIORITY5) : (typeof COMPANY_SERVICE_TYPE_PRIORITY5 == "number" ? COMPANY_SERVICE_TYPE_PRIORITY5 : "0");
        COMPANY_SERVICE_TYPE_DEFAULT = typeof COMPANY_SERVICE_TYPE_DEFAULT == "string" ? (COMPANY_SERVICE_TYPE_DEFAULT.trim() == "" ? "" : COMPANY_SERVICE_TYPE_DEFAULT) : (typeof COMPANY_SERVICE_TYPE_DEFAULT == "number" ? COMPANY_SERVICE_TYPE_DEFAULT : "");
        COMPANY_SERVICE_TYPE_ADD_PRCNTGE5 = typeof COMPANY_SERVICE_TYPE_ADD_PRCNTGE5 == "string" ? (COMPANY_SERVICE_TYPE_ADD_PRCNTGE5.trim() == "" ? "" : COMPANY_SERVICE_TYPE_ADD_PRCNTGE5) : (typeof COMPANY_SERVICE_TYPE_ADD_PRCNTGE5 == "number" ? COMPANY_SERVICE_TYPE_ADD_PRCNTGE5 : "");
        ...
        _child += " COMPANY_SERVICE_TYPE_PRIORITY5=!" + COMPANY_SERVICE_TYPE_PRIORITY5 + "!";
        ...
        _child += " RISE_PECENT5=!" + COMPANY_SERVICE_TYPE_ADD_PRCNTGE5 + "!";
...
function ontxtOPTrf5selection(input) {
    if (input["TARIFF_ID"] == undefined) { tariff_id = input.ID; tariff_name = input._lktext; }
    else { tariff_id = input.TARIFF_ID; tariff_name = input.TARIFF_NAME; }
//    if ((document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtOPTrf2__hiddenID').value == tariff_id)
//    || (document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtOPTrf4__hiddenID').value == tariff_id)
//    || (document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtOPTrf1__hiddenID').value == tariff_id)) {
//        $(".stoast").toastText("Info", "Tariff already Exists in OP Tariff Priority's!", 7, 2);
//        document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtOPTrf5_txtSearchControl').value = "";
//        document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtOPTrf5__hiddenID').value = 0;
//        document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtOPTrf5__hiddenText').value = "";
//        return false;
//    }
    document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtOPTrf5_txtSearchControl').value = tariff_name;
    document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtOPTrf5__hiddenID').value = tariff_id;
    document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtOPTrf5__hiddenText').value = tariff_name;
}
...
/*function ontxtOPTrf5selection(input) {
if (input["TARIFF_ID"] == undefined) {
var input = input.RESULT["ListObjVal"];
input = input[0];
}
document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtOPTrf5_txtSearchControl').value = input.TARIFF_NAME;
document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtOPTrf5__hiddenID').value = input.TARIFF_ID;
document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtOPTrf5__hiddenText').value = input.TARIFF_NAME;
}*/
...
function ontxtIPTrf1selection(input) {
    ...
    if ((document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtIPTrf2__hiddenID').value == tariff_id)
    || (document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtIPTrf3__hiddenID').value == tariff_id)
    || (document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtIPTrf5__hiddenID').value == tariff_id)) {
...
function ontxtIPTrf5selection(input) {
    if (input["TARIFF_ID"] == undefined) {
        tariff_id = input.ID;
        tariff_name = input._lktext;
    }
...
//    || (document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtIPTrf4__hiddenID').value == tariff_id)) {
//        $(".stoast").toastText("Info", "Tariff already Exists in IP Tariff Priority's!", 7, 2);
//        document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtIPTrf5_txtSearchControl').value = "";
//        document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtIPTrf5__hiddenID').value = 0;
//        document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtIPTrf5__hiddenText').value = "";
//        return false;
//    }
    document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtIPTrf5_txtSearchControl').value = tariff_name;
    document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtIPTrf5__hiddenID').value = tariff_id;
    document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtIPTrf5__hiddenText').value = tariff_name;
}
...
document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtIPTrf5_txtSearchControl').value = input.TARIFF_NAME;
document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtIPTrf5__hiddenID').value = input.TARIFF_ID;
document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtIPTrf5__hiddenText').value = input.TARIFF_NAME;
}*/
...
function ontxtERTrf1selection(input) {
    ...
    if ((document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtERTrf2__hiddenID').value == tariff_id)
    || (document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtERTrf3__hiddenID').value == tariff_id)
    || (document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtERTrf5__hiddenID').value == tariff_id)) {
...
function ontxtERTrf5selection(input) {
    if (input["TARIFF_ID"] == undefined) {
        tariff_id = input.ID;
        tariff_name = input._lktext;
    }
    ...
    || (document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtERTrf4__hiddenID').value == tariff_id)) {
        ...
        document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtERTrf5__hiddenID').value = 0;
        document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtERTrf5__hiddenText').value = "";
        return false;
    }
    document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtERTrf5_txtSearchControl').value = tariff_name;
    document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtERTrf5__hiddenID').value = tariff_id;
    document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtERTrf5__hiddenText').value = tariff_name;
}
...
document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtERTrf5_txtSearchControl').value = input.TARIFF_NAME;
document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtERTrf5__hiddenID').value = input.TARIFF_ID;
document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtERTrf5__hiddenText').value = input.TARIFF_NAME;
}*/
...
function ontxtDCTrf1selection(input) {
    ...
    if ((document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtDCTrf2__hiddenID').value == tariff_id)
    || (document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtDCTrf3__hiddenID').value == tariff_id)
    || (document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtDCTrf5__hiddenID').value == tariff_id)) {
...
function ontxtDCTrf5selection(input) {
    if (input["TARIFF_ID"] == undefined) {
        tariff_id = input.ID;
        tariff_name = input._lktext;
    }
    ...
    || (document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtDCTrf3__hiddenID').value == tariff_id)) {
        $(".stoast").toastText("Info", "Tariff already Exists in DC Tariff Priority's!", 7, 2);
        document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtDCTrf5_txtSearchControl').value = "";
        document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtDCTrf5__hiddenID').value = 0;
        document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtDCTrf5__hiddenText').value = "";
        return false;
    }
    document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtDCTrf5_txtSearchControl').value = tariff_name;
    document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtDCTrf5__hiddenID').value = tariff_id;
    document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtDCTrf5__hiddenText').value = tariff_name;
}
...
document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtDCTrf5_txtSearchControl').value = input.TARIFF_NAME;
document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtDCTrf5__hiddenID').value = input.TARIFF_ID;
document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtDCTrf5__hiddenText').value = input.TARIFF_NAME;
}*/
...
function saveGrade() {
    ...
    var editid = getParameterByName('TariffEdit');
...
function CompanyTariffPrioroties(comptrfid, compid, patclass, trfid, priority, is_default, discount, effectfrmdt, effecttodt, color_cd, company_tariff_rev_no, trfname, addprcntge) {
    ...
    if (trfid == ""||trfid ==undefined||trfid ==null||trfid =='undefined')
        trfid = "0";
...
function Cmpnylimit(CmpLimitID, CmpLimitRevNO, compid, patclsid, vldnruleid, CmpCreditlimtamnt, flowid, vldntaxruleid) {
    var OPSERVICE_LIMTS = document.getElementById('ctl00_ContentPlaceHolder1_allowamnt').value;
    if (OPSERVICE_LIMTS == "" || OPSERVICE_LIMTS == null || OPSERVICE_LIMTS == undefined) { OPSERVICE_LIMTS = "0"; }
    ...
    if (vldnruleid == "" || vldnruleid == null || vldnruleid == undefined) { vldnruleid = "0"; }

    if (vldntaxruleid == "" || vldntaxruleid == null || vldntaxruleid == undefined) { vldntaxruleid = "0"; }


    if (CmpCreditlimtamnt > 0 || vldnruleid > 0 || CmpLimitID > 0 || vldntaxruleid > 0) {
        ...
        _xmlStr += " OPSERVICE_LIMTS=^" + OPSERVICE_LIMTS + "^";
        _xmlStr += " COMPANY_TAX_RULE_ID=^" + vldntaxruleid + "^";
        _xmlStr += " />";
    }
}
...
function SavecompanyTariffconfig() {
    ...
    var OPtrf5id = document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtOPTrf5__hiddenID').value; ;
    //document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtOPTrf5__hiddenID').value;
    ...
    var OPtrf5name = document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtOPTrf5_txtSearchControl').value;
    // document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtOPTrf5_txtSearchControl').value;
    ...
    priorityids = OPtrf1id + ',' + OPtrf2id + ',' + OPtrf3id + ',' + OPtrf4id;
    ...
    var opaddprcntge5 = document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtOPaddPrcntge5').value;
    ...
    opaddprcntge5 = opaddprcntge5 == "" ? "0" : opaddprcntge5;
    ...
    var vldntaxruleidOPname = document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_ucruleop_txtSearchControl').value;
    vldntaxruleidOPname = vldntaxruleidOPname == ("") ? "0" : vldntaxruleidOPname;

    if (vldntaxruleidOPname == '0' || vldntaxruleidOPname == "0") {
        document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_ucruleop__hiddenID').value = 0;
    }

    var vldntaxruleidOP = document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_ucruleop__hiddenID').value;
    vldntaxruleidOP = vldntaxruleidOP == ("") ? "0" : vldntaxruleidOP;
    ...
    var IPtrf5id = document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtIPTrf5__hiddenID').value;
    //document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtOPTrf5__hiddenID').value;
    ...
    var IPtrf5name = document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtIPTrf5_txtSearchControl').value;
    //document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtIPTrf5_txtSearchControl').value;
    ...
    var ipaddprcntge5 = document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtIPaddPrcntge5').value;
    ...
    ipaddprcntge5 = ipaddprcntge5 == "" ? "0" : ipaddprcntge5;
    ...
    var vldnruleidIPname = document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtrulenameip').value;
    ...
    var vldntaxruleidiPname = document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_ucruleip_txtSearchControl').value;
    vldntaxruleidiPname = vldntaxruleidiPname == ("") ? "0" : vldntaxruleidiPname;

    if (vldntaxruleidiPname == '0' || vldntaxruleidiPname == "0") {
        document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_ucruleip__hiddenID').value = 0;
    }
    var vldntaxruleidIP = document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_ucruleip__hiddenID').value;
    vldntaxruleidIP = vldntaxruleidIP == ("") ? "0" : vldntaxruleidIP;
    ...
    var ERtrf5id = document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtERTrf5__hiddenID').value; ;
    ...
    var ERtrf5name = document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtERTrf5_txtSearchControl').value;
    ...
    var eraddprcntge5 = document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtERaddPrcntge5').value;
    ...
    eraddprcntge5 = eraddprcntge5 == "" ? "0" : eraddprcntge5;
    ...
    var DCtrf5id = document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtDCTrf5__hiddenID').value;
    ...
    var DCtrf5name = document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtDCTrf5_txtSearchControl').value;
    //document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtDCTrf5_txtSearchControl').value;
    ...
    var dcaddprcntge5 = document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtDCaddPrcntge5').value;
    /* Work Flow */
    ...
    _xmlStr += " AUTH_PERSION =^" + ReplaceSplCharactor(Auth_person) + "^";
    ...
    _xmlStr += " COMPANY_ID=^" + cmpid + "^";
    _xmlStr += " COMPANY_REV_NO=^" + "1" + "^";
    _xmlStr += " CONTACT_PERSON_NAME=^" + ReplaceSplCharactor(Contact_Person_Name) + "^";
    ...
    if (opcount > 0 || ipcount > 0 || ercount > 0 || dccount > 0) {
        if (opcount > 0)
            Cmpnylimit(cmplimitidop, cmplimitrevnoop, cmpid, '2', vldnruleidOP, CmpCreditlimtOP, flowidop, vldntaxruleidOP);
        if (ipcount > 0)
            Cmpnylimit(cmplimitidip, cmplimitrevnoip, cmpid, '1', vldnruleidIP, CmpCreditlimtIP, flowidip,  vldntaxruleidIP);
        if (ercount > 0)
            Cmpnylimit(cmplimitider, cmplimitrevnoer, cmpid, '4', vldnruleidER, CmpCreditlimtER, flowider, 0);
        if (dccount > 0)
            Cmpnylimit(cmplimitiddc, cmplimitrevnodc, cmpid, '5', vldnruleidDC, CmpCreditlimtDC, flowiddc, 0);
    }
    if (opcount > 0 || ipcount > 0 || ercount > 0 || dccount > 0) {
        if (opcount > 0)
...
function BindRuleList(obj) {
    ...
    /* param.ExportParams = { PROC: "PR_GETALL_VALIDATION_RULE", DOC_NAME: "Company Master", IP_COLUMN_NAME: cName, IP_PREFIX_TEXT: pText };
    param.wsPath = "Private/CompanyMaster/CompanyTariffConfiguration.aspx/RuleListBind";
    param.wsFilterPath = "Private/CompanyMaster/CompanyTariffConfiguration.aspx/RuleListBind";*/
...
function disableop(val) {
    ...
    document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtOPTrf5_txtSearchControl').disabled = val;
    ...
    document.getElementById('lk_btn_ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtOPTrf5').disabled = val;
...
function disableip(val) {
    ...
    document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtIPTrf5_txtSearchControl').disabled = val;
    ...
    document.getElementById('lk_btn_ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtIPTrf5').disabled = val;
    ...
    document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtIPaddPrcntge5').value = val;
...
function disableer(val) {
    ...
    document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtERTrf5_txtSearchControl').disabled = val;
    ...
    document.getElementById('lk_btn_ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtERTrf5').disabled = val;
...
function disabledc(val) {
    ...
    document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtDCTrf5_txtSearchControl').disabled = val;
    ...
    document.getElementById('lk_btn_ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtDCTrf5').disabled = val;
...
function iptoop() {
    ...
    document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtIPTrf4__hiddenID').value <= 0) {
        ...
        document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtOPTrf5_txtSearchControl').value = document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtIPTrf5_txtSearchControl').value;
        ...
        document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtOPTrf5__hiddenID').value = document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtIPTrf5__hiddenID').value;
...
function ertoop() {
    ...
    && document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtERTrf4__hiddenID').value <= 0) {
        ...
        document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtOPTrf5_txtSearchControl').value = document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtERTrf5_txtSearchControl').value;
        ...
        document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtOPTrf5__hiddenID').value = document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtERTrf5__hiddenID').value;
...
function dctoop() {
    ...
    document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtDCTrf4__hiddenID').value <= 0) {
        ...
        document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtOPTrf5_txtSearchControl').value = document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtDCTrf5_txtSearchControl').value;
        ...
        document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtOPTrf5__hiddenID').value = document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtDCTrf5__hiddenID').value;
...
function optoip() {
    ...
    document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtOPTrf4__hiddenID').value <= 0) {
        ...
        document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtIPTrf5_txtSearchControl').value = document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtOPTrf5_txtSearchControl').value;
        ...
        document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtIPTrf5__hiddenID').value = document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtOPTrf5__hiddenID').value;
...
function ertoip() {
    ...
    && document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtERTrf4__hiddenID').value <= 0) {
        ...
        document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtIPTrf5_txtSearchControl').value = document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtERTrf5_txtSearchControl').value;
        ...
        document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtIPTrf5__hiddenID').value = document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtERTrf5__hiddenID').value;
...
function dctoip() {
    ...
    document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtDCTrf4__hiddenID').value <= 0) {
        ...
        document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtIPTrf5_txtSearchControl').value = document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtDCTrf5_txtSearchControl').value;
        ...
        document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtIPTrf5__hiddenID').value = document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtDCTrf5__hiddenID').value;
...
function optoer() {
    ...
    document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtOPTrf4__hiddenID').value <= 0) {
        ...
        document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtERTrf5_txtSearchControl').value = document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtOPTrf5_txtSearchControl').value;
        ...
        document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtERTrf5__hiddenID').value = document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtOPTrf5__hiddenID').value;
...
function iptoer() {
    ...
    document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtIPTrf4__hiddenID').value <= 0) {
        ...
        document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtERTrf5_txtSearchControl').value = document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtIPTrf5_txtSearchControl').value;
        ...
        document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtERTrf5__hiddenID').value = document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtIPTrf5__hiddenID').value;
...
function dctoer() {
    ...
    document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtDCTrf4__hiddenID').value <= 0) {
        ...
        document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtERTrf5_txtSearchControl').value = document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtDCTrf5_txtSearchControl').value;
        ...
        document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtERTrf5__hiddenID').value = document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtDCTrf5__hiddenID').value;
...
function optodc() {
    ...
    document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtOPTrf4__hiddenID').value <= 0) {
        ...
        document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtDCTrf5_txtSearchControl').value = document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtOPTrf5_txtSearchControl').value;
        ...
        document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtDCTrf5__hiddenID').value = document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtOPTrf5__hiddenID').value;
...
function iptodc() {
    ...
    document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtIPTrf4__hiddenID').value <= 0) {
        ...
        document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtDCTrf5_txtSearchControl').value = document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtIPTrf5_txtSearchControl').value;
        ...
        document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtDCTrf5__hiddenID').value = document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtIPTrf5__hiddenID').value;
...
function ertodc() {
    ...
    document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtERTrf4__hiddenID').value <= 0) {
        ...
        document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtDCTrf5_txtSearchControl').value = document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtERTrf5_txtSearchControl').value;
        ...
        document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtDCTrf5__hiddenID').value = document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtERTrf5__hiddenID').value;
...
function Onrowflowselection(data, type) {
    //    if (type == "OP") {
    //        document.getElementById('ctl00_ContentPlaceHolder1_hdnflowidop').value = data.WF_ID;
    //        document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtworkflowop').value = data.WF_NAME;
    //    }
    //    else if (type == "IP") {
    //        document.getElementById('ctl00_ContentPlaceHolder1_hdnflowidip').value = data.WF_ID;
    //        document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtworkflowip').value = data.WF_NAME;
    //    }
    //    else if (type == "ER") {
    //        document.getElementById('ctl00_ContentPlaceHolder1_hdnflowider').value = data.WF_ID;
    //        document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtworkflower').value = data.WF_NAME;
    //    }
    //    else {
    //        document.getElementById('ctl00_ContentPlaceHolder1_hdnflowiddc').value = data.WF_ID;
    //       document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtworkflowdc').value = data.WF_NAME;
    //    }
    ctl00_ContentPlaceHolder1_divGridPop.style.display = 'none'
}
...
function ucruleop(input) {
    if (input.RESULT == undefined) /* Lookup Selection */
    {
        document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_ucruleop_txtSearchControl').value = input._lktext;
        document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_ucruleop__hiddenText').value = input._lktext;
        document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_ucruleop__hiddenID').value = input.CNCSN_RULE_ID;
        document.getElementById('ctl00_ContentPlaceHolder1_HDN_TAX_RULE_ID_OP').value = input.CNCSN_RULE_ID;
    } else {
        document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_ucruleop_txtSearchControl').value = input.RESULT.CNCSN_RULE_NAME;
        document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_ucruleop__hiddenText').value = input.RESULT.CNCSN_RULE_NAME;
        document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_ucruleop__hiddenID').value = input.RESULT.CNCSN_RULE_ID;
        document.getElementById('ctl00_ContentPlaceHolder1_HDN_TAX_RULE_ID_OP').value = input.RESULT.CNCSN_RULE_ID;
    }
}
function ucruleip(input) {
    if (input.RESULT == undefined) /* Lookup Selection */
    {
        document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_ucruleip_txtSearchControl').value = input._lktext;
        document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_ucruleip__hiddenText').value = input._lktext;
        document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_ucruleip__hiddenID').value = input.CNCSN_RULE_ID;
        document.getElementById('ctl00_ContentPlaceHolder1_HDN_TAX_RULE_ID_IP').value = input.CNCSN_RULE_ID;
    } else {                                                                             
        document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_ucruleip_txtSearchControl').value = input.RESULT.CNCSN_RULE_ID;
        document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_ucruleip__hiddenText').value = input.RESULT.CNCSN_RULE_NAME;
        document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_ucruleip__hiddenID').value = input.RESULT.CNCSN_RULE_ID;
        document.getElementById('ctl00_ContentPlaceHolder1_HDN_TAX_RULE_ID_IP').value = input.RESULT.CNCSN_RULE_ID;
    }
}
function showusers(obj) {
    ...
    param.pageSize = 10;
    param.pageNum = 1;
    /*param.defaultWSParams = { _cName: cName, _pText: pText, _advSrch: '', flag: 'AB' };
    param.wsPath = "Private/CompanyMaster/CompanyTariffConfiguration.aspx/GetEmployeeDetails";
    param.wsFilterPath = "Private/CompanyMaster/CompanyTariffConfiguration.aspx/GetEmployeeDetails";*/
...
function TabIndexforallFields() {
    ...
    ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtOPTrf4_txtSearchControl.tabIndex = 18;
    ...
    ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtIPTrf5_txtSearchControl.tabIndex = 36;
    ...
    ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtERTrf5_txtSearchControl.tabIndex = 54;
    ...
    ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtDCTrf5_txtSearchControl.tabIndex = 72;
...
function clearpatclasschk(obj) {
    ...
    if (obj.id == "chkpatclass_0") {
        ...
        //        $('[id*=divpatclass] ul li').find('[id*=chkpatclass_3]')[0].checked = false;
        //        $('[id*=divpatclass] ul li').find('[id*=chkpatclass_4]')[0].checked = false;
    }
...
function adddetailspharlevel() {
    var Item_Level = MultiSelectDropdown.GetSelectedList('Ucitemlevel1');
    if (Item_Level == '') {
        $(".stoast").toastText("Info", "Please Select At least One Item Level!", 5, 2);
        document.getElementById('Ucitemlevel1').focus();
        return false;
    }
    var flag = false;
    ...
    var ITEMNAME = '', ITEMCD = '', ITEMID = '', autoid = 0, RECORD_STATUS='';
    ...
    for (var _index = 0; _index < datalebgth; _index++) {
        ...
        $('table[id$=tblitemlevelwisediscount] tr:has(td)').each(function (e) {
            var servicelevalname = $(this).closest('tr').find('[id*=txtlevelName]').val();
            var srvcd = $(this).closest('tr').find('[id*=txtlevelcd]').val();
            var srvcode=srvcd.trim();
            if (srvcode == ITEMCD.trim || servicelevalname.trim() == ITEMNAME.trim()) {
                count++;
            }

        });
            if (count >= 1) {
                $(".stoast").toastText("Info", "This Item Level Name Alreday Exists", 5, 3);
                Sno - 1;
                flag = true;
                return false
            }
...
//        });
        if (flag == false) {
            document.getElementById('ctl00_ContentPlaceHolder1_hdnEmrButtionEnaDis').value = 'N';
            var jDataval = Getlevlitem(ITEMNAME, ITEMCD, ITEMID, autoid, Sno, 0,0, RECORD_STATUS);
            renderGetlevlitem(jDataval);
//            $('table[id$=tblitemlevelwisediscount] tr:has(td)').each(function (e) {
//                $(this).closest('tr').find('[id*=btnremove]').show();
            //            });
...
function Getlevlitem(ITEMNAME, ITEMCD, ITEMID, autoid, Sno, DISC_PER,IP_DISC_PER,RECORD_STATUS, ITEM_ID) {
    ...
    var _param = {
        ...
        IP_DISC_PER: typeof IP_DISC_PER == "number" || typeof IP_DISC_PER == "string" ? IP_DISC_PER : '0',
        ITEMCD: typeof ITEMCD == "number" || typeof ITEMCD == "string" ? ITEMCD : '0',
        RECORD_STATUS: typeof RECORD_STATUS == "number" || typeof RECORD_STATUS == "string" ? RECORD_STATUS : '0'
...
function saveitemlevel() {
    ...
    if (Divdepartment > 1) {
        $('table[id$=tblitemlevelwisediscount] tr:has(td)').each(function (e) {
            ...
            var IPPER = $(this).closest('tr').find('[id*=txtlevelperforip]').val();
            Divname = typeof Divname == "string" ? (Divname.trim() == "0" ? "0" : Divname) : (typeof Divname == "number" ? Gname : "0");
            Desc = typeof Desc == "string" ? (Desc.trim() == "0" ? "0" : Desc) : (typeof Desc == "number" ? Desc : "0");
            if (COMP_EXECUTIVE_ID == "" || COMP_EXECUTIVE_ID == undefined || COMP_EXECUTIVE_ID == null) { COMP_EXECUTIVE_ID = "0"; }
    ...
    $.ajax({
        ...
        success: function (jdata) {
            if (jdata != null) {
                ...
                $(divdata).each(function (i, dataval) {
                    i++;
                    var ITEMNAME = '0', ITEMCD = '', ITEMID = '', autoid = 0,RECORD_STATUS='A';
                    ITEMNAME = dataval.ITEMNAME;
                    ITEMID = dataval.ITEMID;
                    ITEMCD = dataval.ITEMCD;
                    autoid = dataval.AUTOID;
                    DISC_PER = dataval.DISC_PER;
                    IP_DISC_PER = dataval.IP_DISC_PER;
                    RECORD_STATUS = dataval.RECORD_STATUS;
                    Sno = i;
                    var jDataval = Getlevlitem(ITEMNAME, ITEMCD, ITEMID, autoid, Sno, DISC_PER, IP_DISC_PER, RECORD_STATUS);
                    renderGetlevlitem(jDataval);
                });
            }
        },
...
function adddetailspharlevelresrtrict() {
    ...
    for (var _index = 0; _index < datalebgth; _index++) {
        var innerdatitem = PatientTypeID.split(',')[_index].split('-');
        for (i = 0; gridID.rows.length; i++) {
            innerdatitem[1] = innerdatitem[1];
            i++;
...
function ontxtIPTariff5selection() {
}
function ontxtOP_tarif5selection()
{ }
function oncodeselection(input) {
    ClearControl();
    if (input["COMPANY_ID"] == undefined) {
        var input = input.RESULT["ListObjVal"];
        input = input[0];
    }
    document.getElementById('ctl00_ContentPlaceHolder1_txtContactPerson').value = input.CONTACT_PERSON_NAME;
    document.getElementById('ctl00_ContentPlaceHolder1_ucCompanyCode_txtSearchControl').value = input.COMPANY_NAME;
    document.getElementById('ctl00_ContentPlaceHolder1_ucCompanyCode__hiddenID').value = input.COMPANY_ID;
    document.getElementById('ctl00_ContentPlaceHolder1_ucCompanyCode__hiddenText').value = input.COMANY_CD;
    document.getElementById('ctl00_ContentPlaceHolder1_txtCmpName').value = input.COMANY_CD;
    document.getElementById('ctl00_ContentPlaceHolder1_ucCompany_ucCompany__hiddenID').value = input.COMPANY_ID;
    document.getElementById('ctl00_ContentPlaceHolder1_hdncmpnyid').value = input.COMPANY_ID;
    $('#ctl00_ContentPlaceHolder1_ucCompanyCode_txtSearchControl').removeClass('red');
    GetCompanyTariffInfo(input.COMPANY_ID);
    GetCompany_CopyContractInfo(input.COMPANY_ID);
    GetGradeandDivision(input.COMPANY_ID);
    GetCompanyCoverageandtariffrule(input.COMPANY_ID);
    GetService_Group_Type(input.COMPANY_ID);
    GetService_Type(input.COMPANY_ID);
    BindChecklistdata();
    BindPatientClass();
    var pagetitle1 = getParameterByName('TariffEdit');
    if (pagetitle1 == undefined || pagetitle1 == "") {
        Binditemlevel();
        BinditemlevelResrtrict();
        BinditemlevelResrtrict1();
        binddatalevel();
    }
    var tariffId = 1;
    EzHms.Services.HospitalServices.GetEntityLevelCollectionByTariff('WARD_GROUP', tariffId, onwardgroupAsignSucess, onwardgroupfailure)
    if (document.getElementById('ctl00_ContentPlaceHolder1_rbtnfreconsselection_1').checked == true) {
        BindDepartment();
    }
}
function GetCompanyTariffInfo(companyid) {
    debugger;
    GetAsync(
                                  "Private/CompanyMaster/CompanyTariffConfigurationNew.aspx/GetCompanyTariffInfo",
                                  { COMPANYID: companyid },
                                  function (data) {
                                      var data = data.d[0];
                                      for (var i = 0; i <= data.length - 1; i++) {
                                          if (data[i].PATIENT_CLASS_ID == 1) {
                                              debugger;
                                              //rbTariffPrio.SelectedIndex = 2;
                                              document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_trOP').style.display = 'block';
                                              document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_trIP').style.display = 'none';
                                              if (data[i].PRIORITY == 1) {
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtIPTrf1__hiddenID.value = data[i].TARIFF_ID;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtIPTrf1_txtSearchControl.value = data[i].TARIFF_NAME;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtIPTrf1__hiddenText.value = data[i].TARIFF_NAME;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtIPdsc1.value = data[i].DISCOUNT_PERCENT;
                                                  ctl00_ContentPlaceHolder1_hdnip1trfrev.value = data[i].COMPANY_TARIFF_REV_NO;
                                                  ctl00_ContentPlaceHolder1_hdnip1comptrfid.value = data[i].COMPANY_TARIFF_ID;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtIPaddPrcntge1.value = data[i].RISE_PERCENT;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtrulenameip.value = data[i].VALIDATION_RULE_NAME;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_hdncmpruleidip.value = data[i].VALIDATION_RULE_ID;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtipapprlimit.value = data[i].CREDIT_LIMIT_AMT;
                                                  ctl00_ContentPlaceHolder1_hdncmplimitIDIP.value = data[i].COMPANY_LIMIT_ID;
                                                  ctl00_ContentPlaceHolder1_hdncmplimitRevnoIP.value = data[i].COMPANY_LIMIT_REV_NO;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_ucruleip__hiddenText.value = data[i].TAX_RULE_NAME;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_ucruleip_txtSearchControl.value = data[i].TAX_RULE_NAME;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_ucruleip__hiddenID.value = data[i].TAX_RULE_ID;
                                              }
                                              if (data[i].PRIORITY == 2) {
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtIPTrf2__hiddenID.value = data[i].TARIFF_ID;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtIPTrf2_txtSearchControl.value = data[i].TARIFF_NAME;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtIPTrf2__hiddenText.value = data[i].TARIFF_NAME;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtIPdsc2.value = data[i].DISCOUNT_PERCENT;
                                                  ctl00_ContentPlaceHolder1_hdnip2trfrev.value = data[i].COMPANY_TARIFF_REV_NO;
                                                  ctl00_ContentPlaceHolder1_hdnip2comptrfid.value = data[i].COMPANY_TARIFF_ID;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtIPaddPrcntge2.value = data[i].RISE_PERCENT;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtrulenameip.value = data[i].VALIDATION_RULE_NAME;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_hdncmpruleidip.value = data[i].VALIDATION_RULE_ID;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtipapprlimit.text = data[i].CREDIT_LIMIT_AMT;
                                                  ctl00_ContentPlaceHolder1_hdncmplimitIDIP.value = data[i].COMPANY_LIMIT_ID;
                                                  ctl00_ContentPlaceHolder1_hdncmplimitRevnoIP.value = data[i].COMPANY_LIMIT_REV_NO;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_ucruleip__hiddenText.value = data[i].TAX_RULE_NAME;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_ucruleip_txtSearchControl.value = data[i].TAX_RULE_NAME;
                                              ...
                                              if (data[i].PRIORITY == 3) {
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtIPTrf3__hiddenID.value = data[i].TARIFF_ID;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtIPTrf3_txtSearchControl.value = data[i].TARIFF_NAME;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtIPTrf3__hiddenText.value = data[i].TARIFF_NAME;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtIPdsc3.value = data[i].DISCOUNT_PERCENT;
                                                  ctl00_ContentPlaceHolder1_hdnip3trfrev.value = data[i].COMPANY_TARIFF_REV_NO;
                                                  ctl00_ContentPlaceHolder1_hdnip3comptrfid.value = data[i].COMPANY_TARIFF_ID;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtIPaddPrcntge3.value = data[i].RISE_PERCENT;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtrulenameip.value = data[i].VALIDATION_RULE_NAME;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_hdncmpruleidip.value = data[i].VALIDATION_RULE_ID;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtipapprlimit.text = data[i].CREDIT_LIMIT_AMT;
                                                  ctl00_ContentPlaceHolder1_hdncmplimitIDIP.value = data[i].COMPANY_LIMIT_ID;
                                              ...
                                              if (data[i].PRIORITY == 4) {
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtIPTrf4__hiddenID.value = data[i].TARIFF_ID;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtIPTrf4_txtSearchControl.value = data[i].TARIFF_NAME;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtIPTrf4__hiddenText.value = data[i].TARIFF_NAME;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtIPdsc4.value = data[i].DISCOUNT_PERCENT;
                                                  ctl00_ContentPlaceHolder1_hdnip4trfrev.value = data[i].COMPANY_TARIFF_REV_NO;
                                                  ctl00_ContentPlaceHolder1_hdnip4comptrfid.value = data[i].COMPANY_TARIFF_ID;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtIPaddPrcntge4.value = data[i].RISE_PERCENT;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtrulenameip.value = data[i].VALIDATION_RULE_NAME;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_hdncmpruleidip.value = data[i].VALIDATION_RULE_ID;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtipapprlimit.text = data[i].CREDIT_LIMIT_AMT;
                                                  ctl00_ContentPlaceHolder1_hdncmplimitIDIP.value = data[i].COMPANY_LIMIT_ID;
                                              ...
                                              if (data[i].PRIORITY == 5) {
                                                  debugger;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtIPTrf5__hiddenID.value = data[i].TARIFF_ID;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtIPTrf5_txtSearchControl.value = data[i].TARIFF_NAME;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtIPTrf5__hiddenText.value = data[i].TARIFF_NAME;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtIPdsc5.value = data[i].DISCOUNT_PERCENT;
                                                  ctl00_ContentPlaceHolder1_hdnip5trfrev.value = data[i].COMPANY_TARIFF_REV_NO;
                                                  ctl00_ContentPlaceHolder1_hdnip5comptrfid.value = data[i].COMPANY_TARIFF_ID;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtIPaddPrcntge5.value = data[i].RISE_PERCENT;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtrulenameip.value = data[i].VALIDATION_RULE_NAME;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_hdncmpruleidip.value = data[i].VALIDATION_RULE_ID;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtipapprlimit.text = data[i].CREDIT_LIMIT_AMT;
                                                  ctl00_ContentPlaceHolder1_hdncmplimitIDIP.value = data[i].COMPANY_LIMIT_ID;
                                          ...
                                          if (data[i].PATIENT_CLASS_ID == 2) {
                                              debugger;
                                              if (data[i].PRIORITY == 1) {
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtOPTrf1__hiddenID.value = data[i].TARIFF_ID;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtOPTrf1_txtSearchControl.value = data[i].TARIFF_NAME;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtOPTrf1__hiddenText.value = data[i].TARIFF_NAME;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtOPdsc1.value = data[i].DISCOUNT_PERCENT;
                                                  ctl00_ContentPlaceHolder1_hdnop1trfrev.value = data[i].COMPANY_TARIFF_REV_NO;
                                                  ctl00_ContentPlaceHolder1_hdnop1comptrfid.value = data[i].COMPANY_TARIFF_ID;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtOPaddPrcntge1.text = data[i].RISE_PERCENT;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtrulenameop.value = data[i].VALIDATION_RULE_NAME;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_hdncmpruleidop.value = data[i].VALIDATION_RULE_ID;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtopapprlimit.value = data[i].CREDIT_LIMIT_AMT;
                                                  ctl00_ContentPlaceHolder1_hdncmplimitIDOP.value = data[i].COMPANY_LIMIT_ID;
                                                  ctl00_ContentPlaceHolder1_hdncmplimitRevnoOP.value = data[i].COMPANY_LIMIT_REV_NO;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_ucruleop__hiddenText.value = data[i].TAX_RULE_NAME;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_ucruleop_txtSearchControl.value = data[i].TAX_RULE_NAME;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_ucruleop__hiddenID.value = data[i].TAX_RULE_ID;
                                              }
                                              if (data[i].PRIORITY == 2) {
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtOPTrf2__hiddenID.value = data[i].TARIFF_ID;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtOPTrf2_txtSearchControl.value = data[i].TARIFF_NAME;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtOPTrf2__hiddenText.value = data[i].TARIFF_NAME;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtOPdsc2.value = data[i].DISCOUNT_PERCENT;
                                                  ctl00_ContentPlaceHolder1_hdnop2trfrev.value = data[i].COMPANY_TARIFF_REV_NO;
                                                  ctl00_ContentPlaceHolder1_hdnop2comptrfid.value = data[i].COMPANY_TARIFF_ID;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtOPaddPrcntge2.text = data[i].RISE_PERCENT;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtrulenameop.value = data[i].VALIDATION_RULE_NAME;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_hdncmpruleidop.value = data[i].VALIDATION_RULE_ID;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtopapprlimit.value = data[i].CREDIT_LIMIT_AMT;
                                                  ctl00_ContentPlaceHolder1_hdncmplimitIDOP.value = data[i].COMPANY_LIMIT_ID;
                                              ...
                                              if (data[i].PRIORITY == 3) {
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtOPTrf3__hiddenID.value = data[i].TARIFF_ID;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtOPTrf3_txtSearchControl.value = data[i].TARIFF_NAME;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtOPTrf3__hiddenText.value = data[i].TARIFF_NAME;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtOPdsc3.value = data[i].DISCOUNT_PERCENT;
                                                  ctl00_ContentPlaceHolder1_hdnop3trfrev.value = data[i].COMPANY_TARIFF_REV_NO;
                                                  ctl00_ContentPlaceHolder1_hdnop3comptrfid.value = data[i].COMPANY_TARIFF_ID;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtOPaddPrcntge3.text = data[i].RISE_PERCENT;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtrulenameop.value = data[i].VALIDATION_RULE_NAME;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_hdncmpruleidop.value = data[i].VALIDATION_RULE_ID;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtopapprlimit.value = data[i].CREDIT_LIMIT_AMT;
                                                  ctl00_ContentPlaceHolder1_hdncmplimitIDOP.value = data[i].COMPANY_LIMIT_ID;
                                              ...
                                              if (data[i].PRIORITY == 4) {
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtOPTrf4__hiddenID.value = data[i].TARIFF_ID;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtOPTrf4_txtSearchControl.value = data[i].TARIFF_NAME;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtOPTrf4__hiddenText.value = data[i].TARIFF_NAME;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtOPdsc4.text = data[i].DISCOUNT_PERCENT;
                                                  ctl00_ContentPlaceHolder1_hdnop4trfrev.value = data[i].COMPANY_TARIFF_REV_NO;
                                                  ctl00_ContentPlaceHolder1_hdnop4comptrfid.value = data[i].COMPANY_TARIFF_ID;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtOPaddPrcntge4.text = data[i].RISE_PERCENT;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtrulenameop.value = data[i].VALIDATION_RULE_NAME;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_hdncmpruleidop.value = data[i].VALIDATION_RULE_ID;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtopapprlimit.value = data[i].CREDIT_LIMIT_AMT;
                                                  ctl00_ContentPlaceHolder1_hdncmplimitIDOP.value = data[i].COMPANY_LIMIT_ID;
                                              ...
                                              if (data[i].PRIORITY == 5) {
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtOPTrf5__hiddenID.value = data[i].TARIFF_ID;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtOPTrf5_txtSearchControl.value = data[i].TARIFF_NAME;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtOPTrf5__hiddenText.value = data[i].TARIFF_NAME;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtOPdsc4.text = data[i].DISCOUNT_PERCENT;
                                                  ctl00_ContentPlaceHolder1_hdnop5trfrev.value = data[i].COMPANY_TARIFF_REV_NO;
                                                  ctl00_ContentPlaceHolder1_hdnop5comptrfid.value = data[i].COMPANY_TARIFF_ID;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtOPaddPrcntge5.text = data[i].RISE_PERCENT;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtrulenameop.value = data[i].VALIDATION_RULE_NAME;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_hdncmpruleidop.value = data[i].VALIDATION_RULE_ID;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtopapprlimit.value = data[i].CREDIT_LIMIT_AMT;
                                                  ctl00_ContentPlaceHolder1_hdncmplimitIDOP.value = data[i].COMPANY_LIMIT_ID;
                                          ...
                                          if (data[i].PATIENT_CLASS_ID == 4) {
                                              if (data[i].PRIORITY == 1) {
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtERTrf1__hiddenID.value = data[i].TARIFF_ID;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtERTrf1_txtSearchControl.value = data[i].TARIFF_NAME;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtERTrf1__hiddenText.text = data[i].TARIFF_NAME;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtERdsc1.text = data[i].DISCOUNT_PERCENT;
                                                  ctl00_ContentPlaceHolder1_hdner1trfrev.value = data[i].COMPANY_TARIFF_REV_NO;
                                                  ctl00_ContentPlaceHolder1_hdner1comptrfid.value = data[i].COMPANY_TARIFF_ID;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtERaddPrcntge1.value = data[i].RISE_PERCENT;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtrulenameer.value = data[i].VALIDATION_RULE_NAME;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_hdncmpruleider.value = data[i].VALIDATION_RULE_ID;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txterapprlimit.value = data[i].CREDIT_LIMIT_AMT;
                                                  ctl00_ContentPlaceHolder1_hdncmplimitIDER.value = data[i].COMPANY_LIMIT_ID;
                                                  ctl00_ContentPlaceHolder1_hdncmplimitRevnoER.value = data[i].COMPANY_LIMIT_REV_NO;
                                              }
                                              if (data[i].PRIORITY == 2) {
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtERTrf2__hiddenID.value = data[i].TARIFF_ID;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtERTrf2_txtSearchControl.value = data[i].TARIFF_NAME;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtERTrf2__hiddenText.text = data[i].TARIFF_NAME;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtERdsc2.text = data[i].DISCOUNT_PERCENT;
                                                  ctl00_ContentPlaceHolder1_hdner2trfrev.value = data[i].COMPANY_TARIFF_REV_NO;
                                                  ctl00_ContentPlaceHolder1_hdner2comptrfid.value = data[i].COMPANY_TARIFF_ID;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtERaddPrcntge2.value = data[i].RISE_PERCENT;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtrulenameer.value = data[i].VALIDATION_RULE_NAME;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_hdncmpruleider.value = data[i].VALIDATION_RULE_ID;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txterapprlimit.value = data[i].CREDIT_LIMIT_AMT;
                                                  ctl00_ContentPlaceHolder1_hdncmplimitIDER.value = data[i].COMPANY_LIMIT_ID;
                                              ...
                                              if (data[i].PRIORITY == 3) {
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtERTrf3__hiddenID.value = data[i].TARIFF_ID;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtERTrf3_txtSearchControl.value = data[i].TARIFF_NAME;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtERTrf3__hiddenText.text = data[i].TARIFF_NAME;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtERdsc3.value = data[i].DISCOUNT_PERCENT;
                                                  ctl00_ContentPlaceHolder1_hdner3trfrev.value = data[i].COMPANY_TARIFF_REV_NO;
                                                  ctl00_ContentPlaceHolder1_hdner3comptrfid.value = data[i].COMPANY_TARIFF_ID;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtERaddPrcntge3.value = data[i].RISE_PERCENT;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtrulenameer.value = data[i].VALIDATION_RULE_NAME;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_hdncmpruleider.value = data[i].VALIDATION_RULE_ID;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txterapprlimit.value = data[i].CREDIT_LIMIT_AMT;
                                                  ctl00_ContentPlaceHolder1_hdncmplimitIDER.value = data[i].COMPANY_LIMIT_ID;
                                              ...
                                              if (data[i].PRIORITY == 4) {
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtERTrf4__hiddenID.value = data[i].TARIFF_ID;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtERTrf4_txtSearchControl.value = data[i].TARIFF_NAME;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtERTrf4__hiddenText.text = data[i].TARIFF_NAME;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtERdsc4.text = data[i].DISCOUNT_PERCENT;
                                                  ctl00_ContentPlaceHolder1_hdner4trfrev.value = data[i].COMPANY_TARIFF_REV_NO;
                                                  ctl00_ContentPlaceHolder1_hdner4comptrfid.value = data[i].COMPANY_TARIFF_ID;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtERaddPrcntge4.value = data[i].RISE_PERCENT;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtrulenameer.value = data[i].VALIDATION_RULE_NAME;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_hdncmpruleider.value = data[i].VALIDATION_RULE_ID;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txterapprlimit.value = data[i].CREDIT_LIMIT_AMT;
                                                  ctl00_ContentPlaceHolder1_hdncmplimitIDER.value = data[i].COMPANY_LIMIT_ID;
                                              ...
                                              if (data[i].PRIORITY == 5) {
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtERTrf5__hiddenID.value = data[i].TARIFF_ID;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtERTrf5_txtSearchControl.value = data[i].TARIFF_NAME;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtERTrf5__hiddenText.text = data[i].TARIFF_NAME;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtERdsc5.text = data[i].DISCOUNT_PERCENT;
                                                  ctl00_ContentPlaceHolder1_hdner5trfrev.value = data[i].COMPANY_TARIFF_REV_NO;
                                                  ctl00_ContentPlaceHolder1_hdner5comptrfid.value = data[i].COMPANY_TARIFF_ID;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtERaddPrcntge5.value = data[i].RISE_PERCENT;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtrulenameer.value = data[i].VALIDATION_RULE_NAME;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_hdncmpruleider.value = data[i].VALIDATION_RULE_ID;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txterapprlimit.value = data[i].CREDIT_LIMIT_AMT;
                                                  ctl00_ContentPlaceHolder1_hdncmplimitIDER.value = data[i].COMPANY_LIMIT_ID;
                                          ...
                                          if (data[i].PATIENT_CLASS_ID == 5) {
                                              if (data[i].PRIORITY == 1) {
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtDCTrf1__hiddenID.value = data[i].TARIFF_ID;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtDCTrf1_txtSearchControl.value = data[i].TARIFF_NAME;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtDCTrf1__hiddenText.text = data[i].TARIFF_NAME;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtDCdsc1.value = data[i].DISCOUNT_PERCENT;
                                                  ctl00_ContentPlaceHolder1_hdndc1trfrev.value = data[i].COMPANY_TARIFF_REV_NO;
                                                  ctl00_ContentPlaceHolder1_hdndc1comptrfid.value = data[i].COMPANY_TARIFF_ID;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtDCaddPrcntge1.text = data[i].RISE_PERCENT;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtrulenamedc.value = data[i].VALIDATION_RULE_NAME;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_hdncmpruleiddc.value = data[i].VALIDATION_RULE_ID;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtdcapprlimit.value = data[i].CREDIT_LIMIT_AMT;
                                                  ctl00_ContentPlaceHolder1_hdncmplimitIDDC.value = data[i].COMPANY_LIMIT_ID;
                                                  ctl00_ContentPlaceHolder1_hdncmplimitRevnoDC.value = data[i].COMPANY_LIMIT_REV_NO;
                                              }
                                              if (data[i].PRIORITY == 2) {
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtDCTrf2__hiddenID.value = data[i].TARIFF_ID;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtDCTrf2_txtSearchControl.value = data[i].TARIFF_NAME;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtDCTrf2__hiddenText.text = data[i].TARIFF_NAME;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtDCdsc2.text = data[i].DISCOUNT_PERCENT;
                                                  ctl00_ContentPlaceHolder1_hdndc2trfrev.value = data[i].COMPANY_TARIFF_REV_NO;
                                                  ctl00_ContentPlaceHolder1_hdndc2comptrfid.value = data[i].COMPANY_TARIFF_ID;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtDCaddPrcntge2.value = data[i].RISE_PERCENT;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtrulenamedc.value = data[i].VALIDATION_RULE_NAME;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_hdncmpruleiddc.value = data[i].VALIDATION_RULE_ID;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtdcapprlimit.text = data[i].CREDIT_LIMIT_AMT;
                                                  ctl00_ContentPlaceHolder1_hdncmplimitIDDC.value = data[i].COMPANY_LIMIT_ID;
                                                  ctl00_ContentPlaceHolder1_hdncmplimitRevnoDC.value = data[i].COMPANY_LIMIT_REV_NO;
                                              }
                                              if (data[i].PRIORITY == 3) {
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtDCTrf3__hiddenID.value = data[i].TARIFF_ID;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtDCTrf3_txtSearchControl.value = data[i].TARIFF_NAME;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtDCTrf3__hiddenText.text = data[i].TARIFF_NAME;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtDCdsc3.value = data[i].DISCOUNT_PERCENT;
                                                  ctl00_ContentPlaceHolder1_hdndc3trfrev.value = data[i].COMPANY_TARIFF_REV_NO;
                                                  ctl00_ContentPlaceHolder1_hdndc3comptrfid.value = data[i].COMPANY_TARIFF_ID;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtDCaddPrcntge3.value = data[i].RISE_PERCENT;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtrulenamedc.value = data[i].VALIDATION_RULE_NAME;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_hdncmpruleiddc.value = data[i].VALIDATION_RULE_ID;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtdcapprlimit.value = data[i].CREDIT_LIMIT_AMT;
                                                  ctl00_ContentPlaceHolder1_hdncmplimitIDDC.value = data[i].COMPANY_LIMIT_ID;
                                              ...
                                              if (data[i].PRIORITY == 4) {
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtDCTrf4__hiddenID.value = data[i].TARIFF_ID;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtDCTrf4_txtSearchControl.value = data[i].TARIFF_NAME;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtDCTrf4__hiddenText.text = data[i].TARIFF_NAME;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtDCdsc4.text = data[i].DISCOUNT_PERCENT;
                                                  ctl00_ContentPlaceHolder1_hdndc4trfrev.value = data[i].COMPANY_TARIFF_REV_NO;
                                                  ctl00_ContentPlaceHolder1_hdndc4comptrfid.value = data[i].COMPANY_TARIFF_ID;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtDCaddPrcntge4.value = data[i].RISE_PERCENT;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtrulenamedc.value = data[i].VALIDATION_RULE_NAME;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_hdncmpruleiddc.value = data[i].VALIDATION_RULE_ID;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtdcapprlimit.value = data[i].CREDIT_LIMIT_AMT;
                                                  ctl00_ContentPlaceHolder1_hdncmplimitIDDC.value = data[i].COMPANY_LIMIT_ID;
                                              ...
                                              if (data[i].PRIORITY == 5) {
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtDCTrf5__hiddenID.value = data[i].TARIFF_ID;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtDCTrf5_txtSearchControl.value = data[i].TARIFF_NAME;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtDCTrf5__hiddenText.text = data[i].TARIFF_NAME;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtDCdsc5.text = data[i].DISCOUNT_PERCENT;
                                                  ctl00_ContentPlaceHolder1_hdndc5trfrev.value = data[i].COMPANY_TARIFF_REV_NO;
                                                  ctl00_ContentPlaceHolder1_hdndc5comptrfid.value = data[i].COMPANY_TARIFF_ID;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtDCaddPrcntge5.value = data[i].RISE_PERCENT;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtrulenamedc.value = data[i].VALIDATION_RULE_NAME;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_hdncmpruleiddc.value = data[i].VALIDATION_RULE_ID;
                                                  ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtdcapprlimit.value = data[i].CREDIT_LIMIT_AMT;
                                                  ctl00_ContentPlaceHolder1_hdncmplimitIDDC.value = data[i].COMPANY_LIMIT_ID;
                              ...
                              function GetCompany_CopyContractInfo(companyid) {
                                  GetAsync(
                                  "Private/CompanyMaster/CompanyTariffConfigurationNew.aspx/GetCompany_CopyContractInfo",
                                  { COMPANYID: companyid },
                                  function (data) {
                                      var data = data.d[0];
                                      for (var i = 0; i <= data.length - 1; i++) {
                                          ctl00_ContentPlaceHolder1_txtapprovallimitamt.value = data[i].APPROVAL_LIMIT_AMT;
                                          ctl00_ContentPlaceHolder1_txttdsper.value = data[i].TDS_PER;
                                          if (data[i].PATIENT_CLASS_ID == 2) {
                                              ctl00_ContentPlaceHolder1_txtEmppercent_OP.value = data[i].EMP_PERCENT;
                                              ctl00_ContentPlaceHolder1_txtOrgpercent_OP.value = data[i].ORG_PERCENT;
                                              ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtoporgper.value = data[i].ORG_PERCENT;
                                              ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtopempper.value = data[i].EMP_PERCENT;
                                              ctl00_ContentPlaceHolder1_hdnopcopayrevno.value = data[i].COMPANY_COPAY_REV_NO;
                                              ctl00_ContentPlaceHolder1_hdnopcopayid.value = data[i].COMPANY_COPAY_ID;
                                              ctl00_ContentPlaceHolder1_hdnflowidop.value = data[i].BILL_WF_ID;
                                          }
                                          if (data[i].PATIENT_CLASS_ID == 1) {
                                              ctl00_ContentPlaceHolder1_txtEmppercent_IP.value = data[i].EMP_PERCENT;
                                              ctl00_ContentPlaceHolder1_txtOrgpercent_IP.value = data[i].ORG_PERCENT;
                                              ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtiporgper.value = data[i].ORG_PERCENT;
                                              ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtipempper.value = data[i].EMP_PERCENT;
                                              ctl00_ContentPlaceHolder1_hdnipcopayrevno.value = data[i].COMPANY_COPAY_REV_NO;
                                              ctl00_ContentPlaceHolder1_hdnipcopayid.value = data[i].COMPANY_COPAY_ID;
                                              ctl00_ContentPlaceHolder1_hdnflowidip.value = data[i].BILL_WF_ID;
                                          }
                                          if (data[i].PATIENT_CLASS_ID == 4) {
                                              ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txterorgper.value = data[i].EMP_PERCENT;
                                              ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txterempper.value = data[i].ORG_PERCENT;
                                              ctl00_ContentPlaceHolder1_hdnercopayrevno.value = data[i].COMPANY_COPAY_REV_NO;
                                              ctl00_ContentPlaceHolder1_hdnercopayid.value = data[i].COMPANY_COPAY_ID;
                                              ctl00_ContentPlaceHolder1_hdnflowider.value = data[i].BILL_WF_ID;
                                          }
                                          if (data[i].PATIENT_CLASS_ID == 5) {
                                              ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtdcorgper.value = data[i].EMP_PERCENT;
                                              ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_txtdcempper.value = data[i].ORG_PERCENT;
                                              ctl00_ContentPlaceHolder1_hdndccopayrevno.value = data[i].COMPANY_COPAY_REV_NO;
                                              ctl00_ContentPlaceHolder1_hdndccopayid.value = data[i].COMPANY_COPAY_ID;
                                              ctl00_ContentPlaceHolder1_hdnflowiddc.value = data[i].BILL_WF_ID;
                                          }
                                          document.getElementById('ctl00_ContentPlaceHolder1_ucCompanyCode_txtSearchControl').value = data[0].COMPANY_NAME;
                                          if (data[0].COLOUR_ID != undefined && data[0].COLOUR_ID != '') {
                                              document.getElementById('ctl00_ContentPlaceHolder1_txtColor').value = data[0].COLOUR_ID;
                                              document.getElementById('ctl00_ContentPlaceHolder1_pnlcolor').style.backgroundColor = data[0].COLOUR_ID;
                                          }
                                          document.getElementById('ctl00_ContentPlaceHolder1_txtDiscount').value = data[0].PHAR_DISC_PERC;
                                          document.getElementById('ctl00_ContentPlaceHolder1_hdncomprevno').value = data[0].COMPANY_REV_NO;
                                          document.getElementById('ctl00_ContentPlaceHolder1_hdncmpnycntactrevno').value = data[0].COMPANY_CONTACT_REV_NO;
                                          document.getElementById('ctl00_ContentPlaceHolder1_txtCmpName').value = data[0].COMANY_CD;
                                          document.getElementById('ctl00_ContentPlaceHolder1_ucTariff_txtSearchControl').value = data[0].TARIFF_NAME;
                                          document.getElementById('ctl00_ContentPlaceHolder1_ucTariff__hiddenText').value = data[0].TARIFF_NAME;
                                          document.getElementById('ctl00_ContentPlaceHolder1_HidAuthID').value = data[0].REG_AUTHORITY_ID;
                                          document.getElementById('ctl00_ContentPlaceHolder1_txtAuthorizedperson').value = data[0].REGISTRING_AUTHORITY_NAME;
                                          document.getElementById('ctl00_ContentPlaceHolder1_txtContractNo').value = data[0].CONTRACT_NO;
                                          document.getElementById('ctl00_ContentPlaceHolder1_hdncontractRevNo').value = data[0].COMPANY_CONTRACT_REV_NO;
                                          document.getElementById('ctl00_ContentPlaceHolder1_hdncontactrevno').value = data[0].COMPANY_CONTACT_REV_NO;
                                          document.getElementById('ctl00_ContentPlaceHolder1_hdncontactid').value = data[0].COMPANY_CONTACT_ID;
                                          document.getElementById('ctl00_ContentPlaceHolder1_hdncontractid').value = data[0].COMPANY_CONTRACT_ID;

                                          document.getElementById('ctl00_ContentPlaceHolder1_txtEfectFrom').value = new Date(data[0].EFFECT_FROM_DT).format('dd-MMM-yyyy');
                                          document.getElementById('ctl00_ContentPlaceHolder1_txtEfectTo').value = new Date(data[0].EFFECT_TO_DT).format('dd-MMM-yyyy');
                                          document.getElementById('ctl00_ContentPlaceHolder1_txtStDt').value = new Date(data[0].CONTRACT_DT).format('dd-MMM-yyyy');
                                          document.getElementById('ctl00_ContentPlaceHolder1_txtAuthorizedperson').value = data[0].AUTH_PERSION;
                                          document.getElementById('ctl00_ContentPlaceHolder1_txtRegFee').value = data[0].COMPANY_FEE;
                                          document.getElementById('ctl00_ContentPlaceHolder1_txtConsNOs').value = data[0].VAL_NO_OF_CONSULTATIONS;
                                          document.getElementById('ctl00_ContentPlaceHolder1_hdnConsNos').value = data[0].VAL_NO_OF_CONSULTATIONS;
                                          document.getElementById('ctl00_ContentPlaceHolder1_txtConsDAYs').value = data[0].VAL_NO_OF_DAYS;
                                          document.getElementById('ctl00_ContentPlaceHolder1_txtNotes').value = data[0].CONTRACT_NOTES;
                                          if (data[0].CONCESSION_PRIORITY != undefined && data[0].CONCESSION_PRIORITY != null) {
                                              document.getElementById('ctl00_ContentPlaceHolder1_ddlservices').value = data[0].CONCESSION_PRIORITY;
                                              Ddlconprchange();
                                          }
                                          if (data[0].CONCESSION_PRIORITY == 'Y') {
                                              document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_chkLeterRequired').checked = true;
                                          } else {
                                              document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel2_chkLeterRequired').checked = false;
                                          }
                                          if (data[0].IS_RATE_INC == 'Y') {
                                              document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel21_chkbx_0').checked = true;
                                          }
                                          else {
                                              document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel21_chkbx_0').checked = false;
                                          }
                                          if (data[0].IS_CONSELIGIBLE_WARD == 'Y') {
                                              document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel21_chkbx_1').checked = true;
                                          }
                                          else {
                                              document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel21_chkbx_1').checked = false;
                                          }
                                          if (data[0].REQ_REPORT_FORMAT == 'Y') {
                                              document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel21_chkbx_2').checked = true;
                                          }
                                          else {
                                              document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel21_chkbx_2').checked = false;
                                          }
                                          if (data[0].SRV_APPROVAL_REQ_FLAG == 'Y') {

                                          }
                                          document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel21_txtCorpBilDone').value = data[0].CORP_BILLDONE_DAYS;
                                          document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel21_txtsubmitMktg').value = data[0].SUBMIT_TO_MKTG;
                                          document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel21_txtsubmittoOrg').value = data[0].SUBMIT_TO_ORG;
                                          document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel21_txtBilCleardays').value = data[0].BILL_CLEARENCE_DAYS;
                                          document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel21_txtdschrgbills').value = data[0].SUBMIT_TO_MKTG_DISCHRG;
                                          if (data[0].OP_CONS_PAYMENT == 'C') {
                                              document.getElementById('ctl00_ContentPlaceHolder1_rbCorpConsultation').value = 1;
                                          }
                                          if (data[0].OP_CONS_PAYMENT == 'R') {
                                              document.getElementById('ctl00_ContentPlaceHolder1_rbCorpConsultation').value = 2;
                                          }
                                          document.getElementById('ctl00_ContentPlaceHolder1_txtconsultationdiscper').value = data[0].CONSULTATION_DISC_PER;
                                          document.getElementById('ctl00_ContentPlaceHolder1_txtfreeconsultationdays').value = data[0].FREE_CONSULTATION_DAYS;
                                          if (data[0].FREE_CONSULTATION_TYPE_ID == 2) {
                                              ctl00_ContentPlaceHolder1_rbtnfreconsselection_1.checked = true
                                          }
                                          if (data[0].FREE_CONSULTATION_TYPE_ID == 1) {
                                              ctl00_ContentPlaceHolder1_rbtnfreconsselection_0.checked = true
                                          }
                                          document.getElementById('ctl00_ContentPlaceHolder1_rbtnfreconsselection').value = data[0].FREE_CONSULTATION_TYPE_ID;
                                          document.getElementById('ctl00_ContentPlaceHolder1_RadioButtonList1').value = data[0].PHARMACY_CASH_CREDIT_ID;
                                          document.getElementById('ctl00_ContentPlaceHolder1_txtphardiscper').value = data[0].PHARMACY_CASH_CREDIT_DISC_PER;
                                          if (data[0].IS_FREE_CONSULTATION != "") {
                                              if (data[0].IS_FREE_CONSULTATION == 'Y') {
                                                  document.getElementById('ctl00_ContentPlaceHolder1_chkfreeconsultation').checked = true;
                                              } else {
                                                  document.getElementById('ctl00_ContentPlaceHolder1_chkfreeconsultation').checked = false;
                                              }
                                          }
                                          if (data[0].IS_PHARMACY_SERVICE_TAX != "") {
                                              if (data[0].IS_PHARMACY_SERVICE_TAX == 'Y') {
                                                  document.getElementById('ctl00_ContentPlaceHolder1_chkpharservicetax').checked = true;
                                              } else {
                                                  document.getElementById('ctl00_ContentPlaceHolder1_chkpharservicetax').checked = false;
                                              }
                                          }
                                          document.getElementById('ctl00_ContentPlaceHolder1_txtservicetxper').value = data[0].PHARMACY_SERVICE_TAX_PER;
                                          document.getElementById('ctl00_ContentPlaceHolder1_txtnumberofprints').value = data[0].PHARMACY_NUMBER_OF_PRINTS;
                                          document.getElementById('ctl00_ContentPlaceHolder1_txtPharmacyValidity').value = data[0].PHARMACY_VALIDITY_DAYS;


                                          if (data[0].CORP_CONSULTATION_TYPE_ID == 1) {
                                              document.getElementById('ctl00_ContentPlaceHolder1_rbtncorpconsultations_0').checked = true;
                                          }
                                          if (data[0].CORP_CONSULTATION_TYPE_ID == 2) {
                                              document.getElementById('ctl00_ContentPlaceHolder1_rbtncorpconsultations_1').checked = true;
                                          }
                                          if (data[0].CORP_CONSULTATION_TYPE_ID == 3) {
                                              document.getElementById('ctl00_ContentPlaceHolder1_rbtncorpconsultations_2').checked = true;
                                          }

                                          if (data[0].PHARMACY_CASH_CREDIT_ID == 1) {
                                              document.getElementById('ctl00_ContentPlaceHolder1_RadioButtonList1_0').checked = true;
                                          }
                                          if (data[0].PHARMACY_CASH_CREDIT_ID == 2) {
                                              document.getElementById('ctl00_ContentPlaceHolder1_RadioButtonList1_1').checked = true;
                                          }
                                          if (data[0].TARIFF_RULE_ID == 1) {
                                              document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel21_rblCompare_0').checked = true;
                                          }
                                          if (data[0].TARIFF_RULE_ID == 2) {
                                              document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel21_rblCompare_1').checked = true;
                                          }
                                          if (data[0].TARIFF_RULE_ID == 3) {
                                              document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel21_rblCompare_2').checked = true;
                                          }
                                          document.getElementById('ctl00_ContentPlaceHolder1_rbtncorpconsultations').value = data[0].CORP_CONSULTATION_TYPE_ID;
                                          document.getElementById('ctl00_ContentPlaceHolder1_rbtnformatepriority').value = data[0].FORMATE_PRIORITY_FOR_STATEMENTS;
                                          if (data[0].IS_WARD_NAME_REQUIRED_IN_REPORT != "") {
                                              if (data[0].IS_WARD_NAME_REQUIRED_IN_REPORT == 'Y') {
                                                  document.getElementById('ctl00_ContentPlaceHolder1_chkisnotreqward').checked = true;
                                              } else {
                                                  document.getElementById('ctl00_ContentPlaceHolder1_chkisnotreqward').checked = false;
                                              }
                                          }

                                          if (data[0].IS_AAROGYASRI != "") {
                                              if (data[0].IS_AAROGYASRI == 'Y') {
                                                  document.getElementById('ctl00_ContentPlaceHolder1_chkisargsry').checked = true;
                                              } else {
                                                  document.getElementById('ctl00_ContentPlaceHolder1_chkisargsry').checked = false;
                                              }
                                          }
                                          if (data[0].IS_DISCHARGE_MEDICATION != "") {
                                              if (data[0].IS_DISCHARGE_MEDICATION == 'Y') {
                                                  document.getElementById('ctl00_ContentPlaceHolder1_chkdischmedictaion').checked = true;
                                              } else {
                                                  document.getElementById('ctl00_ContentPlaceHolder1_chkdischmedictaion').checked = false;
                                              }
                                          }
                                          if (data[0].IS_REQUIRED_DUE_AMT_EQ_TO_AP_AMT != "") {
                                              if (data[0].IS_REQUIRED_DUE_AMT_EQ_TO_AP_AMT == 'Y') {
                                                  document.getElementById('ctl00_ContentPlaceHolder1_chkduemateqappramt').checked = true;
                                              } else {
                                                  document.getElementById('ctl00_ContentPlaceHolder1_chkduemateqappramt').checked = false;
                                              }
                                          }
                                          if (data[0].IS_SALE_AS_PRC_RATE != "") {
                                              if (data[0].IS_SALE_AS_PRC_RATE == 'Y') {
                                                  document.getElementById('ctl00_ContentPlaceHolder1_chksaleaspurcrate').checked = true;
                                              } else {
                                                  document.getElementById('ctl00_ContentPlaceHolder1_chksaleaspurcrate').checked = false;
                                              }
                                          }
                                          if (data[0].IS_SMS_REQ != "") {
                                              if (data[0].IS_SMS_REQ == 'Y') {
                                                  document.getElementById('ctl00_ContentPlaceHolder1_chksmsrequired').checked = true;
                                              } else {
                                                  document.getElementById('ctl00_ContentPlaceHolder1_chksmsrequired').checked = false;
                                              }
                                          }
                                          if (data[0].IS_BILLING_HEAD_EDIT != "") {
                                              if (data[0].IS_BILLING_HEAD_EDIT == 'Y') {
                                                  document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel8_chkbillinhead').checked = true;
                                              } else {
                                                  document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel8_chkbillinhead').checked = false;
                                              }
                                          }
                                          if (data[0].IS_RATE_EDIT != "") {
                                              if (data[0].IS_RATE_EDIT == 'Y') {
                                                  document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel8_chkRate').checked = true;
                                              } else {
                                                  document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel8_chkRate').checked = false;
                                              }
                                          }
                                          if (data[0].IS_SERVICE_CD_EDIT != "") {
                                              if (data[0].IS_SERVICE_CD_EDIT == 'Y') {
                                                  document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel8_chkServiceCd').checked = true;
                                              } else {
                                                  document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel8_chkServiceCd').checked = false;
                                              }
                                          }
                                          if (data[0].IS_SERVICE_NAME_EDIT != "") {
                                              if (data[0].IS_SERVICE_NAME_EDIT == 'Y') {
                                                  document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel8_chkServiceName').checked = true;
                                              } else {
                                                  document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel8_chkServiceName').checked = false;
                                              }
                                          }
                                          if (data[0].IS_QTY_EDIT != "") {
                                              if (data[0].IS_QTY_EDIT == 'Y') {
                                                  document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel8_chkQuantity').checked = true;
                                              } else {
                                                  document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel8_chkQuantity').checked = false;
                                              }
                                          }
                                          if (data[0].IS_POSTED_DATE_EDIT != "") {
                                              if (data[0].IS_POSTED_DATE_EDIT == 'Y') {
                                                  document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel8_chkposteddate').checked = true;
                                              } else {
                                                  document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel8_chkposteddate').checked = false;
                                              }
                                          }
                                          if (data[0].IS_NEW_SERVICE_INSERT != "") {
                                              if (data[0].IS_NEW_SERVICE_INSERT == 'Y') {
                                                  document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel8_chkNewServiceInsert').checked = true;
                                              } else {
                                                  document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel8_chkNewServiceInsert').checked = false;
                                              }
                                          }
                                          if (data[0].IS_REMOVE_SERVICE != "") {
                                              if (data[0].IS_REMOVE_SERVICE == 'Y') {
                                                  document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel8_chkRemoveSevices').checked = true;
                                              } else {
                                                  document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel8_chkRemoveSevices').checked = false;
                                              }
                                          }
                                          document.getElementById('ctl00_ContentPlaceHolder1_TabContainer1_TabPanel11_txtMedicationValue').value = data[0].DISC_MEDIC_LIMIT_PER;
                                      }
                                  },
                                  function (jqXHR, textStatus, errorThrown) {
                                  });
                              }
                              function GetCompanyCoverageandtariffrule(companyid) {
                                  GetAsync(
                                  "Private/CompanyMaster/CompanyTariffConfigurationNew.aspx/GetCompanyCoverageandtariffrule",
                                  { COMPANYID: companyid },
                                  function (data) {
                                      var data = data.d[0];
                                      for (var i = 0; i <= data.length - 1; i++) {
                                          if (data[i].COVERAGE_ID == 1) {
                                              document.getElementById('ctl00_ContentPlaceHolder1_hdnipcoverageid').value = data[i].COMPANY_COVERAGE_ID;
                                              document.getElementById('ctl00_ContentPlaceHolder1_hdnipcvrgrevno').value = data[i].COMPANY_COVERAGE_REV_NO;
                                          }
                                          if (data[i].COVERAGE_ID == 2) {
                                              document.getElementById('ctl00_ContentPlaceHolder1_hdnopcoverageid').value = data[i].COMPANY_COVERAGE_ID;
                                              document.getElementById('ctl00_ContentPlaceHolder1_hdnopcvrgrevno').value = data[i].COMPANY_COVERAGE_REV_NO;
                                          }
                                          if (data[i].COVERAGE_ID == 4) {
                                              document.getElementById('ctl00_ContentPlaceHolder1_hdnercoverageid').value = data[i].COMPANY_COVERAGE_ID;
                                              document.getElementById('ctl00_ContentPlaceHolder1_hdnercvrgrevno').value = data[i].COMPANY_COVERAGE_REV_NO;
                                          }
                                          if (data[i].COVERAGE_ID == 5) {
                                              document.getElementById('ctl00_ContentPlaceHolder1_hdndccoverageid').value = data[i].COMPANY_COVERAGE_ID;
                                              document.getElementById('ctl00_ContentPlaceHolder1_hdndccvrgrevno').value = data[i].COMPANY_COVERAGE_REV_NO;

                                          }
                                          document.getElementById('ctl00_ContentPlaceHolder1_hdntrfrulerevno').value = data[i].COMPANY_TARIFF_RULE_REV_NO;
                                          document.getElementById('ctl00_ContentPlaceHolder1_hdncmptrfruleid').value = data[i].COMPANY_TARIFF_RULE_ID;
                                      }
                                  },
                                  function (jqXHR, textStatus, errorThrown) {
                                  });
                              }
                              function GetService_Group_Type(COMPANYID) {
                                  GetAsync(
                                  "Private/CompanyMaster/CompanyTariffConfigurationNew.aspx/GetService_Group_TypeSelect",
                                  { COMPANYID: COMPANYID },
                                  function (data) {
                                      var result = data.d[0];
                                      if (result != null && result != undefined && result != "") {
                                          for (var i = 0; i <= data.d.length - 1; i++) {
                                              var j = i + 1;
                                              $('table[id$=ctl00_ContentPlaceHolder1_TabContainer1_TabPanel1_gvservicegroup] tr').filter(':eq(' + j + ')').find('[id*=hdnautoid]').val(data.d[i].CMP_SRV_TYPE_ID);
                                              $('table[id$=ctl00_ContentPlaceHolder1_TabContainer1_TabPanel1_gvservicegroup] tr').filter(':eq(' + j + ')').find('[id*=hdnrevno]').val(data.d[i].SERVICE_TYPE_REV_NO);
                                              $('table[id$=ctl00_ContentPlaceHolder1_TabContainer1_TabPanel1_gvservicegroup] tr').filter(':eq(' + j + ')').find('input[type=text][id*=txtpririty1]').val(data.d[i].COMPANY_SERVICE_TYPE_PRIORITY1);
                                              $('table[id$=ctl00_ContentPlaceHolder1_TabContainer1_TabPanel1_gvservicegroup] tr').filter(':eq(' + j + ')').find('input[type=text][id*=txtpririty2]').val(data.d[i].COMPANY_SERVICE_TYPE_PRIORITY2);
                                              $('table[id$=ctl00_ContentPlaceHolder1_TabContainer1_TabPanel1_gvservicegroup] tr').filter(':eq(' + j + ')').find('input[type=text][id*=txtpririty3]').val(data.d[i].COMPANY_SERVICE_TYPE_PRIORITY3);
                                              $('table[id$=ctl00_ContentPlaceHolder1_TabContainer1_TabPanel1_gvservicegroup] tr').filter(':eq(' + j + ')').find('input[type=text][id*=txtpririty4]').val(data.d[i].COMPANY_SERVICE_TYPE_DEFAULT);
                                              $('table[id$=ctl00_ContentPlaceHolder1_TabContainer1_TabPanel1_gvservicegroup] tr').filter(':eq(' + j + ')').find('input[type=text][id*=txtAddpririty1]').val(data.d[i].RISE_PERCENT1);
                                              $('table[id$=ctl00_ContentPlaceHolder1_TabContainer1_TabPanel1_gvservicegroup] tr').filter(':eq(' + j + ')').find('input[type=text][id*=txtAddpririty2]').val(data.d[i].RISE_PERCENT2);
                                              $('table[id$=ctl00_ContentPlaceHolder1_TabContainer1_TabPanel1_gvservicegroup] tr').filter(':eq(' + j + ')').find('input[type=text][id*=txtAddpririty3]').val(data.d[i].RISE_PERCENT3);
                                              $('table[id$=ctl00_ContentPlaceHolder1_TabContainer1_TabPanel1_gvservicegroup] tr').filter(':eq(' + j + ')').find('input[type=text][id*=txtAddpririty4]').val(data.d[i].RISE_PERCENTDEFAULT);
                                          }
                                      }
                                  },
                                  function (jqXHR, textStatus, errorThrown) {
                              ...
                              function GetService_Type(COMPANYID) {
                                  GetAsync(
                                  "Private/CompanyMaster/CompanyTariffConfigurationNew.aspx/GetService_TypeSelect",
                                  { COMPANYID: COMPANYID },
                                  function (data) {
                                      var result = data.d[0];
                                      if (result != null && result != undefined && result != "") {
                                          for (var i = 0; i <= data.d.length - 1; i++) {
                                              ...
                                              $('table[id$=ctl00_ContentPlaceHolder1_TabContainer1_TabPane22_gvServicesType] tr').filter(':eq(' + j + ')').find('[id*=hdnautoid]').val(data.d[i].CMP_SRV_TYPE_ID);
                                              $('table[id$=ctl00_ContentPlaceHolder1_TabContainer1_TabPane22_gvServicesType] tr').filter(':eq(' + j + ')').find('[id*=hdnrevno]').val(data.d[i].SERVICE_TYPE_REV_NO);
                                              $('table[id$=ctl00_ContentPlaceHolder1_TabContainer1_TabPane22_gvServicesType] tr').filter(':eq(' + j + ')').find('input[type=text][id*=txtpririty1]').val(data.d[i].COMPANY_SERVICE_TYPE_PRIORITY1);
                                              $('table[id$=ctl00_ContentPlaceHolder1_TabContainer1_TabPane22_gvServicesType] tr').filter(':eq(' + j + ')').find('input[type=text][id*=txtpririty2]').val(data.d[i].COMPANY_SERVICE_TYPE_PRIORITY2);
                                              $('table[id$=ctl00_ContentPlaceHolder1_TabContainer1_TabPane22_gvServicesType] tr').filter(':eq(' + j + ')').find('input[type=text][id*=txtpririty3]').val(data.d[i].COMPANY_SERVICE_TYPE_PRIORITY3);
                                              $('table[id$=ctl00_ContentPlaceHolder1_TabContainer1_TabPane22_gvServicesType] tr').filter(':eq(' + j + ')').find('input[type=text][id*=txtpririty4]').val(data.d[i].COMPANY_SERVICE_TYPE_DEFAULT);
                                              $('table[id$=ctl00_ContentPlaceHolder1_TabContainer1_TabPane22_gvServicesType] tr').filter(':eq(' + j + ')').find('input[type=text][id*=txtAddpririty1]').val(data.d[i].RISE_PERCENT1);
                                              $('table[id$=ctl00_ContentPlaceHolder1_TabContainer1_TabPane22_gvServicesType] tr').filter(':eq(' + j + ')').find('input[type=text][id*=txtAddpririty2]').val(data.d[i].RISE_PERCENT2);
                                              $('table[id$=ctl00_ContentPlaceHolder1_TabContainer1_TabPane22_gvServicesType] tr').filter(':eq(' + j + ')').find('input[type=text][id*=txtAddpririty3]').val(data.d[i].RISE_PERCENT3);
                                              $('table[id$=ctl00_ContentPlaceHolder1_TabContainer1_TabPane22_gvServicesType] tr').filter(':eq(' + j + ')').find('input[type=text][id*=txtAddpririty4]').val(data.d[i].RISE_PERCENTDEFAULT);
                                          }
                                      }
                                  },
                                  function (jqXHR, textStatus, errorThrown) {
                            ...
                            function maximimannum() { 

                                $('table[id$=tblitemlevelwisediscount] tr:has(td)').each(function (e) {
           var PER = $(this).closest('tr').find('[id*=txtlevelper]').val();
            if(PER>100)
                $(this).closest('tr').find('[id*=txtlevelper]').val(0);
    ...
    function maximimannumip() {

        $('table[id$=tblitemlevelwisediscount] tr:has(td)').each(function (e) {
            var PER = $(this).closest('tr').find('[id*=txtlevelperforip]').val();
            if (PER > 100)
                $(this).closest('tr').find('[id*=txtlevelperforip]').val(0);
