...
//        height2 = $(window).height() - HH;

//        $('.contentbody').css("height", height2);
//        vH = $('.contentbody').height() - 45;

//        $('.main-form-div').css("height", mainformdivH);
//        $('.mainlookup').css({ height: ($(window).height() - 40) + "px" });
//        $('.row-2').css("height", "400px");
//        $('.row-22').css("height", "400px");
//        $('.row-23').css("height", "400px");
//        $('.trow-2,.trow-3').css("height", "400px");

//        $('.SuGridH').css({ height: ($(".contentbody").height() - 48) + "px" });
//        grdsearch1 = $(".grdsearch").height() + 45;
...
//        $('.GFgriddiv').css({ height: ($(".GFgridheght").height() - 35) + "px" });
        ...
        var HH = ''; var FH = ''; HH = $("#topnav").outerHeight() + 11; FH = $("#bottomnav").outerHeight(); HFH = HH + FH; height1 = $(window).height() - 100; $('.nav-menu-drop').css("min-height", "500px"); $('.nav-menu-drop').css("max-height", height1);
        var height2 = '';
        ...
        row2h = $(".row-12").height() + 0;
        rowheight = row1h + row2h + 10;
        $('.row-22').css({ height: ($(".main-form-div,.main-form-div2").height() - rowheight) + "px" });

        row21h = $(".row-12").height() + 0;
        rowheight12 = row1h + row21h + 0;
        $('.row-222').css({ height: ($(".main-form-div2").height() - rowheight12) + "px" });
        ...
        dprow1h = $(".row-1").height() + $(".row-12").height() + 35;
        $('.dprow-3').css({ height: ($(".main-form-div,.main-form-div2").height() - dprow1h) + "px" });

        $('.Rgridheght1').css({ height: ($(".row-22").height() - 45) + "px" });
        $('.Rgridheght').css({ height: ($(".row-2,.row-22,.trow-2,trow-3,dprow-3").height() - 37) + "px" });
        ...
        $("#tab4").click(function () { $("#tabbody4").show(); $("#tabbody2,#tabbody3,#tabbody1,#tabbody5,#tabbody6").hide(); $("#tab4").addClass("tabselect"); $("#tab2,#tab3,#tab5,#tab1,#tab6").removeClass("tabselect"); });
        ...
        $('.panel-fullscreen .w2ui-grid-box').css({ height: ($(".panel-fullscreen .divpkgsrvs").height() - 0) + "px" });
        $('.panel-fullscreen .w2ui-grid-box').css("background", "red !important");
...
$(document).ready(function () {
    ...
    $(".resizefull").click(function (e) {
        ...
        e.preventDefault();
        var $this = $(this);
        if ($this.children('i').hasClass('icon-resize-full')) {

            $this.children('i').removeClass('icon-resize-full');
            $this.children('i').addClass('icon-resize-small');

        }
        else if ($this.children('i').hasClass('icon-resize-small')) {
            $this.children('i').removeClass('icon-resize-small');
            $this.children('i').addClass('icon-resize-full');
        }
        $(this).closest('.panel-div,.panel-divW').toggleClass('panel-fullscreen');
        w2ui.divw2igridInner.refresh()
    });
