    ...
    (function (factory) {
        ...
        var defaults = {
            ...
            template: '<div class="webui-popover">' +
                ...
                '<div class="webui-popover-content divscroll"><i class="icon-refresh"></i> <p>&nbsp;</p></div>' +
                '</div>' +
                '</div>',
            backdrop: false,
            dismissible: true,
            ...
            */
            ...
            getContent: function () {
                if (this.getUrl()) {
                    ...
                    var _html = "<ul class=\"modulelist list-group\">";
                    var _subhtml = "";
                    ...
                    _.each(_collection, function (i, j) {
                        ...
                        if (i.PARENT_MODULE_ID != null)
                            ...
                            _html += "<li  class=\"list-group-item\"><a onclick=\"ManageS(" + i.PARENT_DOC_ID + "," + i.PARENT_MODULE_ID + "," + i.DOC_ID + ",'" + i.DOC_TYPE + "','" + i.DOC_DESC + "','" + i.PAGE_URL.replace("~/", $("#_abspath").val()) + "','" + i.IS_TOKENSYSTEM + "','" + i.GRID_PAGE_URL.replace("~/", $("#_abspath").val()) + "','" + i.MODULE_FORM_CD + "','" + i.DOC_DESC + "','" + i.DOC_FORM_CD + "')\">" + i.DOC_DESC + "</a></li>";
                        _subhtml = "";
                        ...
                        if (_.where(subitems, { PARENT_DOC_ID: i.DOC_ID, DOC_ID_TYPE: 'D' }).length > 0) {
                            ...
                            _.each(_.where(subitems, { PARENT_DOC_ID: i.DOC_ID, PARENT_DOC_ID_TYPE: 'M' }), function (k, l) {
                                _subhtml += "<li  class=\"list-group-item\"><a onclick=\"ManageS(" + i.PARENT_DOC_ID + "," + i.DOC_ID + "," + k.DOC_ID + ",'" + k.DOC_TYPE + "','" + k.DOC_DESC + "','" + k.PAGE_URL.replace("~/", $("#_abspath").val()) + "','" + k.IS_TOKENSYSTEM + "','" + k.GRID_PAGE_URL.replace("~/", $("#_abspath").val()) + "','" + i.MODULE_FORM_CD + "','" + k.DOC_DESC + "','" + k.DOC_FORM_CD + "')\">" + k.DOC_DESC + "</a></li>";
                            })
                            _subhtml += "</ul></div></li>";
