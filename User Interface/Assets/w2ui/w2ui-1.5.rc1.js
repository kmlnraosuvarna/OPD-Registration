            ...
            if ($.isArray(menu)) {
                for (var m = 0; m < menu.length; m++) {
                    if (typeof menu[m] == 'string') {
                        ...
                        if (menu[m].caption != null) menu[m].caption = menu[m].caption;
                        if (menu[m].checked != null) menu[m].checked = menu[m].checked;
                    }
                }
                return menu;
      ...
      //  debugger;
          ...
          //  debugger;
            for (var f = 0; f < this.fields.length; f++) {
                ...
                // input control
             //   debugger;
                var input = '<input name="'+ field.name +'" class="w2ui-input" type="text" '+ field.html.attr +' tabindex="'+ (f+1) +'" value="'+field.value +'" />';
                switch (field.type) {
                    case 'pass':
                    case 'password':
                    ...
                    case 'checkbox':
                            if(field.value=='Yes')
                            {
                               input = '<input name="'+ field.name +'" class="w2ui-input" type="checkbox" '+ field.html.attr +' tabindex="'+ (f+1) +'" checked/>';
                            }
                            else
                            {
                    ...
                    case 'radio':
                     ...
                     //   debugger;
                        for (var i = 0; i < items.length; i++) {
                            input += '<label><input name="' + field.name + '" class="w2ui-input" type = "radio" ' + field.html.attr + ' value="'+ items[i].id + '"  checked="'+items[i].checked+'" />' +
